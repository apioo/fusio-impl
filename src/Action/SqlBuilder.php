...
class SqlBuilder implements ActionInterface
{
    ...
    public function configure(BuilderInterface $builder, ElementFactoryInterface $elementFactory)
    {
        ...
        $builder->add($elementFactory->newTextArea('definition', 'Definition', 'json', 'The JSON definition to build a nested response. Click <a ng-click="help.showDialog(\'help/json-builder.md\')">here</a> for more informations about the JSON format.'));
    }
