...
use Fusio\Impl\Backend\Action\Agent\Introduction;
...
class NewInstallation
{
    public static function getData(?string $tenantId = null): DataBag
    {
        ...
        $bag->addAgent('default', null, Table\Agent::TYPE_GENERAL, false, 'Fusio-General', 'Provides real-time instance insights and debugging. Explores your setup to analyze operations, tables, and logs.', self::readAgent('general.md'), null, [
        ...
        $bag->addAgent('default', null, Table\Agent::TYPE_ARCHITECT, false, 'Fusio-Architect', 'Builds complete API operations by coordinating schemas, database tables, and business logic.', self::readAgent('architect.md'), null, [], Model\Agent\Blueprint::class, tenantId: $tenantId);
        $bag->addAgent('default', null, Table\Agent::TYPE_ACTION, false, 'Fusio-Action', 'Develops custom business logic and backend code for your API operations.', self::readAgent('action.md'), Introduction\Action::class, [
            'backend_connection_getAll',
            'backend_connection_get',
            'backend_connection_database_getTables',
            'backend_connection_database_getTable',
        ...
        $bag->addAgent('default', null, Table\Agent::TYPE_SCHEMA, false, 'Fusio-Schema', 'Designs JSON schemas to define and validate request/response data structures.', self::readAgent('schema.md'), Introduction\Schema::class, [
        ], Model\Agent\Schema::class, tenantId: $tenantId);
        $bag->addAgent('default', null, Table\Agent::TYPE_DATABASE, false, 'Fusio-Database', 'Designs database table structures including columns, types, and constraints.', self::readAgent('database.md'), null, [
            'backend_connection_database_getTables',
            'backend_connection_database_getTable',
        ], Model\Agent\Database::class, tenantId: $tenantId);
        $bag->addAgent('default', null, Table\Agent::TYPE_SEED, false, 'Fusio-Seed', 'Populates tables with context-aware data. Generates realistic test records or accurate factual data for production.', self::readAgent('seed.md'), null, [
            'backend_connection_database_getTables',
            'backend_connection_database_getTable',
        ...
        return [
            ...
            'backend' => [
                ...
                'agent.getAll' => new Operation(
                    action: Backend\Action\Agent\GetAll::class,
                    httpMethod: 'GET',
                    httpPath: '/agent',
                    httpCode: 200,
                ...
                'agent.create' => new Operation(
                    action: Backend\Action\Agent\Create::class,
                    httpMethod: 'POST',
                    httpPath: '/agent',
                    httpCode: 201,
                    outgoing: Model\Common\Message::class,
                    incoming: Model\Backend\AgentCreate::class,
                    throws: [999 => Model\Common\Message::class],
                    eventName: 'fusio.agent.create',
                    description: 'Creates a new agent',
                ),
                'agent.get' => new Operation(
                    action: Backend\Action\Agent\Get::class,
                    httpMethod: 'GET',
                    httpPath: '/agent/$agent_id<[0-9]+|^~>',
                    httpCode: 200,
                    outgoing: Model\Backend\Agent::class,
                    throws: [999 => Model\Common\Message::class],
                    description: 'Returns a specific agent',
                ),
                'agent.update' => new Operation(
                    action: Backend\Action\Agent\Update::class,
                    httpMethod: 'PUT',
                    httpPath: '/agent/$agent_id<[0-9]+|^~>',
                    httpCode: 200,
                    outgoing: Model\Common\Message::class,
                    incoming: Model\Backend\AgentUpdate::class,
                    throws: [999 => Model\Common\Message::class],
                    eventName: 'fusio.agent.update',
                    description: 'Updates an existing agent',
                ),
                'agent.delete' => new Operation(
                    action: Backend\Action\Agent\Delete::class,
                    httpMethod: 'DELETE',
                    httpPath: '/agent/$agent_id<[0-9]+|^~>',
                    httpCode: 200,
                    outgoing: Model\Common\Message::class,
                    throws: [999 => Model\Common\Message::class],
                    eventName: 'fusio.agent.delete',
                    description: 'Deletes an existing agent',
                ),
                'agent.getTools' => new Operation(
                    action: Backend\Action\Agent\GetTools::class,
                    httpMethod: 'GET',
                ...
                'agent.message.getAll' => new Operation(
                    action: Backend\Action\Agent\Message\GetAll::class,
                    httpMethod: 'GET',
                    httpPath: '/agent/$agent_id<[0-9]+|^~>/message',
                    httpCode: 200,
                    outgoing: Model\Backend\AgentMessageCollection::class,
                    parameters: ['ref_id' => PropertyTypeFactory::getInteger(), 'chat_id' => PropertyTypeFactory::getString()],
                    throws: [999 => Model\Common\Message::class],
                    description: 'Returns a paginated list of agent messages',
                ),
                'agent.message.submit' => new Operation(
                    action: Backend\Action\Agent\Message\Submit::class,
                    httpMethod: 'POST',
                    httpPath: '/agent/$agent_id<[0-9]+|^~>/message',
                    httpCode: 201,
                    outgoing: Model\Agent\Output::class,
                    parameters: ['ref_id' => PropertyTypeFactory::getInteger()],
                ...
                'marketplace.bundle.getAll' => new Operation(
                    action: Backend\Action\Marketplace\Bundle\GetAll::class,
                    httpMethod: 'GET',
                    httpPath: '/marketplace/bundle',
                    httpCode: 200,
                    outgoing: Marketplace\MarketplaceBundleCollection::class,
                    parameters: ['startIndex' => PropertyTypeFactory::getInteger(), 'query' => PropertyTypeFactory::getString()],
                    throws: [999 => Model\Common\Message::class],
                    description: 'Returns a paginated list of marketplace bundles',
                ),
                'marketplace.bundle.install' => new Operation(
                    action: Backend\Action\Marketplace\Bundle\Install::class,
                    httpMethod: 'POST',
                    httpPath: '/marketplace/bundle',
                    httpCode: 201,
                    outgoing: Marketplace\MarketplaceMessage::class,
                ...
                'marketplace.bundle.get' => new Operation(
                    action: Backend\Action\Marketplace\Bundle\Get::class,
                    httpMethod: 'GET',
                    httpPath: '/marketplace/bundle/:user/:name',
                    httpCode: 200,
                    outgoing: Marketplace\MarketplaceBundle::class,
                    throws: [999 => Model\Common\Message::class],
                    description: 'Returns a specific marketplace bundle',
                ),
                'marketplace.bundle.upgrade' => new Operation(
                    action: Backend\Action\Marketplace\Bundle\Upgrade::class,
                    httpMethod: 'PUT',
                    httpPath: '/marketplace/bundle/:user/:name',
                    httpCode: 200,
                    outgoing: Marketplace\MarketplaceMessage::class,
                ...
                'bundle.getAll' => new Operation(
                    action: Backend\Action\Bundle\GetAll::class,
                    httpMethod: 'GET',
                    httpPath: '/bundle',
                    httpCode: 200,
                    outgoing: Model\Backend\BundleCollection::class,
                    parameters: ['startIndex' => PropertyTypeFactory::getInteger(), 'count' => PropertyTypeFactory::getInteger(), 'search' => PropertyTypeFactory::getString()],
                    throws: [999 => Model\Common\Message::class],
                    description: 'Returns a paginated list of bundles',
                ),
                'bundle.create' => new Operation(
                    action: Backend\Action\Bundle\Create::class,
                    httpMethod: 'POST',
                    httpPath: '/bundle',
                    httpCode: 201,
                    outgoing: Model\Common\Message::class,
                    incoming: Model\Backend\BundleCreate::class,
                    throws: [999 => Model\Common\Message::class],
                    eventName: 'fusio.bundle.create',
                    description: 'Creates a new bundle',
                ),
                'bundle.get' => new Operation(
                    action: Backend\Action\Bundle\Get::class,
                    httpMethod: 'GET',
                ...
                'bundle.update' => new Operation(
                    action: Backend\Action\Bundle\Update::class,
                    httpMethod: 'PUT',
                    httpPath: '/bundle/$bundle_id<[0-9]+|^~>',
                    httpCode: 200,
                    outgoing: Model\Common\Message::class,
                ...
                'bundle.delete' => new Operation(
                    action: Backend\Action\Bundle\Delete::class,
                    httpMethod: 'DELETE',
                    httpPath: '/bundle/$bundle_id<[0-9]+|^~>',
                    httpCode: 200,
                    outgoing: Model\Common\Message::class,
                ...
                'taxonomy.getAll' => new Operation(
                    action: Backend\Action\Taxonomy\GetAll::class,
                    httpMethod: 'GET',
                    httpPath: '/taxonomy',
                    httpCode: 200,
                    outgoing: Model\Backend\TaxonomyCollection::class,
                    parameters: ['startIndex' => PropertyTypeFactory::getInteger(), 'count' => PropertyTypeFactory::getInteger(), 'search' => PropertyTypeFactory::getString()],
                    throws: [999 => Model\Common\Message::class],
                    description: 'Returns a paginated list of taxonomies',
                ),
                'taxonomy.create' => new Operation(
                    action: Backend\Action\Taxonomy\Create::class,
                    httpMethod: 'POST',
                    httpPath: '/taxonomy',
                    httpCode: 201,
                    outgoing: Model\Common\Message::class,
                    incoming: Model\Backend\TaxonomyCreate::class,
                    throws: [999 => Model\Common\Message::class],
                    eventName: 'fusio.taxonomy.create',
                    description: 'Creates a new taxonomy',
                ),
                'taxonomy.get' => new Operation(
                    action: Backend\Action\Taxonomy\Get::class,
                    httpMethod: 'GET',
                    httpPath: '/taxonomy/$taxonomy_id<[0-9]+|^~>',
                    httpCode: 200,
                    outgoing: Model\Backend\Taxonomy::class,
                    throws: [999 => Model\Common\Message::class],
                    description: 'Returns a specific taxonomy',
                ),
                'taxonomy.update' => new Operation(
                    action: Backend\Action\Taxonomy\Update::class,
                    httpMethod: 'PUT',
                    httpPath: '/taxonomy/$taxonomy_id<[0-9]+|^~>',
                    httpCode: 200,
                    outgoing: Model\Common\Message::class,
                    incoming: Model\Backend\TaxonomyUpdate::class,
                    throws: [999 => Model\Common\Message::class],
                    eventName: 'fusio.taxonomy.update',
                    description: 'Updates an existing taxonomy',
                ),
                'taxonomy.delete' => new Operation(
                    action: Backend\Action\Taxonomy\Delete::class,
                    httpMethod: 'DELETE',
                    httpPath: '/taxonomy/$taxonomy_id<[0-9]+|^~>',
                    httpCode: 200,
                    outgoing: Model\Common\Message::class,
                ...
                'transaction.getAll' => new Operation(
                    ...
                    parameters: ['startIndex' => PropertyTypeFactory::getInteger(), 'count' => PropertyTypeFactory::getInteger(), 'search' => PropertyTypeFactory::getString(), 'from' => PropertyTypeFactory::getDateTime(), 'to' => PropertyTypeFactory::getDateTime(), 'planId' => PropertyTypeFactory::getInteger(), 'userId' => PropertyTypeFactory::getInteger(), 'appId' => PropertyTypeFactory::getInteger(), 'status' => PropertyTypeFactory::getString(), 'provider' => PropertyTypeFactory::getString(), 'taxonomy' => PropertyTypeFactory::getInteger()],
                    throws: [999 => Model\Common\Message::class],
