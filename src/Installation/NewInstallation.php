        ...
        return [
            'default' => [
                'getAbout' => new Operation(
                    ...
                    httpPath: '/',
                    httpCode: 200,
                    return: Model\System\About::class,
                    public: true
                ),
            ],
            'backend' => [
                ...
                'page.getAll' => new Operation(
                    ...
                    httpPath: '/page',
                    httpCode: 200,
                    return: Model\Backend\PageCollection::class,
                    arguments: ['startIndex' => TypeFactory::getInteger(), 'count' => TypeFactory::getInteger(), 'search' => TypeFactory::getString()],
                ),
                'page.create' => new Operation(
                    ...
                    httpCode: 201,
                    return: Message::class,
                    arguments: ['payload' => Model\Backend\PageCreate::class],
                ),
                'page.get' => new Operation(
                    ...
                    httpCode: 200,
                    return: Model\Backend\Page::class,
                ),
                'page.update' => new Operation(
                    ...
                    httpCode: 200,
                    return: Message::class,
                    arguments: ['payload' => Model\Backend\PageUpdate::class],
                ),
                ...
                'plan.getAll' => new Operation(
                    ...
                    httpPath: '/plan',
                    httpCode: 200,
                    return: Model\Backend\PlanCollection::class,
                    arguments: ['startIndex' => TypeFactory::getInteger(), 'count' => TypeFactory::getInteger(), 'search' => TypeFactory::getString()],
                ),
                'plan.create' => new Operation(
                    ...
                    httpCode: 201,
                    return: Message::class,
                    arguments: ['payload' => Model\Backend\PlanCreate::class],
                ),
                'plan.get' => new Operation(
                    ...
                    httpCode: 200,
                    return: Model\Backend\Plan::class,
                ),
                'plan.update' => new Operation(
                    ...
                    httpCode: 200,
                    return: Message::class,
                    arguments: ['payload' => Model\Backend\PlanUpdate::class],
                ),
                ...
                'rate.getAll' => new Operation(
                    ...
                    httpPath: '/rate',
                    httpCode: 200,
                    return: Model\Backend\RateCollection::class,
                    arguments: ['startIndex' => TypeFactory::getInteger(), 'count' => TypeFactory::getInteger(), 'search' => TypeFactory::getString()],
                ),
                'rate.create' => new Operation(
                    ...
                    httpCode: 201,
                    return: Message::class,
                    arguments: ['payload' => Model\Backend\RateCreate::class],
                ),
                'rate.get' => new Operation(
                    ...
                    httpCode: 200,
                    return: Model\Backend\Rate::class,
                ),
                'rate.update' => new Operation(
                    ...
                    httpCode: 200,
                    return: Message::class,
                    arguments: ['payload' => Model\Backend\RateUpdate::class],
                ),
                ...
                'role.getAll' => new Operation(
                    ...
                    httpPath: '/role',
                    httpCode: 200,
                    return: Model\Backend\RoleCollection::class,
                    arguments: ['startIndex' => TypeFactory::getInteger(), 'count' => TypeFactory::getInteger(), 'search' => TypeFactory::getString()],
                ),
                'role.create' => new Operation(
                    ...
                    httpCode: 201,
                    return: Message::class,
                    arguments: ['payload' => Model\Backend\RoleCreate::class],
                ),
                'role.get' => new Operation(
                    ...
                    httpCode: 200,
                    return: Model\Backend\Role::class,
                ),
                'role.update' => new Operation(
                    ...
                    httpCode: 200,
                    return: Message::class,
                    arguments: ['payload' => Model\Backend\RoleUpdate::class],
                ),
                ...
                'operation.getAll' => new Operation(
                    action: Backend\Action\Route\GetAll::class,
                    httpMethod: 'GET',
                    httpPath: '/routes',
                    httpCode: 200,
                    return: Model\Backend\RouteCollection::class,
                    arguments: ['categoryId' => TypeFactory::getInteger(), 'startIndex' => TypeFactory::getInteger(), 'count' => TypeFactory::getInteger(), 'search' => TypeFactory::getString()],
                ),
                'operation.create' => new Operation(
                    action: Backend\Action\Route\Create::class,
                    httpMethod: 'POST',
                    httpPath: '/routes',
                    httpCode: 201,
                    return: Message::class,
                    arguments: ['payload' => Model\Backend\RouteCreate::class],
                ),
                'operation.get' => new Operation(
                    action: Backend\Action\Route\Get::class,
                    httpMethod: 'GET',
                    httpPath: '/routes/$route_id<[0-9]+>',
                    httpCode: 200,
                    return: Model\Backend\Route::class,
                ),
                'operation.update' => new Operation(
                    action: Backend\Action\Route\Update::class,
                    httpMethod: 'PUT',
                    httpPath: '/routes/$route_id<[0-9]+>',
                    httpCode: 200,
                    return: Message::class,
                    arguments: ['payload' => Model\Backend\RouteUpdate::class],
                ),
                ...
                'schema.getAll' => new Operation(
                    ...
                    httpPath: '/schema',
                    httpCode: 200,
                    return: Model\Backend\SchemaCollection::class,
                    arguments: ['categoryId' => TypeFactory::getInteger(), 'startIndex' => TypeFactory::getInteger(), 'count' => TypeFactory::getInteger(), 'search' => TypeFactory::getString()],
                ),
                'schema.create' => new Operation(
                    ...
                    httpCode: 201,
                    return: Message::class,
                    arguments: ['payload' => Model\Backend\SchemaCreate::class],
                ),
                'schema.getPreview' => new Operation(
                    ...
                    httpCode: 200,
                    return: Model\Backend\SchemaPreviewResponse::class,
                ),
                'schema.updateForm' => new Operation(
                    ...
                    httpCode: 200,
                    return: Message::class,
                    arguments: ['payload' => Model\Backend\SchemaForm::class],
                ),
                'schema.get' => new Operation(
                    ...
                    httpCode: 200,
                    return: Model\Backend\Schema::class,
                ),
                'schema.update' => new Operation(
                    ...
                    httpCode: 200,
                    return: Message::class,
                    arguments: ['payload' => Model\Backend\SchemaUpdate::class],
                ),
                ...
                'scope.getAll' => new Operation(
                    ...
                    httpPath: '/scope',
                    httpCode: 200,
                    return: Model\Backend\ScopeCollection::class,
                    arguments: ['categoryId' => TypeFactory::getInteger(), 'startIndex' => TypeFactory::getInteger(), 'count' => TypeFactory::getInteger(), 'search' => TypeFactory::getString()],
                ),
                'scope.create' => new Operation(
                    ...
                    httpCode: 201,
                    return: Message::class,
                    arguments: ['payload' => Model\Backend\ScopeCreate::class],
                ),
                'scope.getCategories' => new Operation(
                    ...
                    httpCode: 200,
                    return: Model\Backend\ScopeCategories::class,
                ),
                'scope.get' => new Operation(
                    ...
                    httpCode: 200,
                    return: Model\Backend\Scope::class,
                ),
                'scope.update' => new Operation(
                    ...
                    httpCode: 200,
                    return: Message::class,
                    arguments: ['payload' => Model\Backend\ScopeUpdate::class],
                ),
                ...
                'sdk.getAll' => new Operation(
                    ...
                    httpPath: '/sdk',
                    httpCode: 200,
                    return: Model\Backend\SdkResponse::class,
                ),
                'sdk.generate' => new Operation(
                    ...
                    httpCode: 200,
                    return: Message::class,
                    arguments: ['payload' => Model\Backend\SdkGenerate::class],
                ),
                'statistic.getCountRequests' => new Operation(
                    ...
                    httpCode: 200,
                    return: Model\Backend\StatisticCount::class,
                    arguments: ['startIndex' => TypeFactory::getInteger(), 'count' => TypeFactory::getInteger(), 'search' => TypeFactory::getString(), 'from' => TypeFactory::getDateTime(), 'to' => TypeFactory::getDateTime(), 'routeId' => TypeFactory::getInteger(), 'appId' => TypeFactory::getInteger(), 'userId' => TypeFactory::getInteger(), 'ip' => TypeFactory::getString(), 'userAgent' => TypeFactory::getString(), 'method' => TypeFactory::getString(), 'path' => TypeFactory::getString(), 'header' => TypeFactory::getString(), 'body' => TypeFactory::getString()],
                ),
                'statistic.getErrorsPerRoute' => new Operation(
                    ...
                    httpCode: 200,
                    return: Model\Backend\StatisticChart::class,
                    arguments: ['startIndex' => TypeFactory::getInteger(), 'count' => TypeFactory::getInteger(), 'search' => TypeFactory::getString(), 'from' => TypeFactory::getDateTime(), 'to' => TypeFactory::getDateTime(), 'routeId' => TypeFactory::getInteger(), 'appId' => TypeFactory::getInteger(), 'userId' => TypeFactory::getInteger(), 'ip' => TypeFactory::getString(), 'userAgent' => TypeFactory::getString(), 'method' => TypeFactory::getString(), 'path' => TypeFactory::getString(), 'header' => TypeFactory::getString(), 'body' => TypeFactory::getString()],
                ),
                ...
                'transaction.getAll' => new Operation(
                    ...
                    httpCode: 200,
                    return: Model\Backend\TransactionCollection::class,
                ...
                'transaction.get' => new Operation(
                    ...
                    httpCode: 200,
                    return: Model\Backend\Transaction::class,
                ),
                'trash.getTypes' => new Operation(
                    ...
                    httpPath: '/trash',
                    httpCode: 200,
                    return: Model\Backend\TrashTypes::class,
                ),
                'trash.getAllByType' => new Operation(
                    ...
                    httpPath: '/trash/:type',
                    httpCode: 200,
                    return: Model\Backend\TrashDataCollection::class,
                    arguments: ['startIndex' => TypeFactory::getInteger(), 'count' => TypeFactory::getInteger(), 'search' => TypeFactory::getString()],
                ),
                'trash.restore' => new Operation(
                    ...
                    httpCode: 200,
                    return: Message::class,
                    arguments: ['payload' => Model\Backend\TrashRestore::class],
                ),
                'user.getAll' => new Operation(
                    ...
                    httpPath: '/user',
                    httpCode: 200,
                    return: Model\Backend\UserCollection::class,
                    arguments: ['startIndex' => TypeFactory::getInteger(), 'count' => TypeFactory::getInteger(), 'search' => TypeFactory::getString()],
                ),
                'user.create' => new Operation(
                    ...
                    httpCode: 201,
                    return: Message::class,
                    arguments: ['payload' => Model\Backend\UserCreate::class],
                ),
            ...
            'consumer' => [
                'app.getAll' => new Operation(
                    ...
                    httpPath: '/app',
                    httpCode: 200,
                    return: Model\Consumer\AppCollection::class,
                    arguments: ['startIndex' => TypeFactory::getInteger(), 'count' => TypeFactory::getInteger(), 'search' => TypeFactory::getString()],
                ),
                'app.create' => new Operation(
                    ...
                    httpCode: 201,
                    return: Message::class,
                    arguments: ['payload' => Model\Consumer\AppCreate::class],
                ),
                'app.get' => new Operation(
                    ...
                    httpPath: '/app/$app_id<[0-9]+>',
                    httpCode: 200,
                    return: Model\Consumer\App::class,
                ),
                'app.update' => new Operation(
                    ...
                    httpCode: 200,
                    return: Message::class,
                    arguments: ['payload' => Model\Consumer\AppUpdate::class],
                ),
                'app.delete' => new Operation(
                ...
                'event.getAll' => new Operation(
                    ...
                    httpPath: '/event',
                    httpCode: 200,
                    return: Model\Consumer\EventCollection::class,
                    arguments: ['startIndex' => TypeFactory::getInteger(), 'count' => TypeFactory::getInteger(), 'search' => TypeFactory::getString()],
                ),
                'grant.getAll' => new Operation(
                    ...
                    httpPath: '/grant',
                    httpCode: 200,
                    return: Model\Consumer\GrantCollection::class,
                    arguments: ['startIndex' => TypeFactory::getInteger(), 'count' => TypeFactory::getInteger(), 'search' => TypeFactory::getString()],
                ),
                ...
                'log.getAll' => new Operation(
                    ...
                    httpPath: '/log',
                    httpCode: 200,
                    return: Model\Consumer\LogCollection::class,
                    arguments: ['startIndex' => TypeFactory::getInteger(), 'count' => TypeFactory::getInteger(), 'search' => TypeFactory::getString()],
                ),
                'log.get' => new Operation(
                    ...
                    httpPath: '/log/$log_id<[0-9]+>',
                    httpCode: 200,
                    return: Model\Consumer\Log::class,
                ),
                'page.getAll' => new Operation(
                    ...
                    httpPath: '/page',
                    httpCode: 200,
                    return: Model\Consumer\PageCollection::class,
                    arguments: ['startIndex' => TypeFactory::getInteger(), 'count' => TypeFactory::getInteger(), 'search' => TypeFactory::getString()],
                ),
                'page.get' => new Operation(
                    ...
                    httpCode: 200,
                    return: Model\Consumer\Page::class,
                ),
                'payment.portal' => new Operation(
                    ...
                    httpCode: 200,
                    return: Model\Consumer\PaymentPortalResponse::class,
                    arguments: ['payload' => Model\Consumer\PaymentPortalRequest::class],
                ),
                'payment.checkout' => new Operation(
                    ...
                    httpCode: 200,
                    return: Model\Consumer\PaymentCheckoutRequest::class,
                    arguments: ['payload' => Model\Consumer\PaymentCheckoutResponse::class],
                ),
                'plan.getAll' => new Operation(
                    ...
                    httpPath: '/plan',
                    httpCode: 200,
                    return: Model\Consumer\PlanCollection::class,
                    arguments: ['startIndex' => TypeFactory::getInteger(), 'count' => TypeFactory::getInteger(), 'search' => TypeFactory::getString()],
                ),
                'plan.get' => new Operation(
                    ...
                    httpPath: '/plan/$plan_id<[0-9]+>',
                    httpCode: 200,
                    return: Model\Consumer\Plan::class,
                ),
                'scope.getAll' => new Operation(
                    ...
                    httpPath: '/scope',
                    httpCode: 200,
                    return: Model\Consumer\ScopeCollection::class,
                    arguments: ['startIndex' => TypeFactory::getInteger(), 'count' => TypeFactory::getInteger(), 'search' => TypeFactory::getString()],
                ),
                'subscription.getAll' => new Operation(
                    ...
                    httpCode: 200,
                    return: Model\Consumer\EventSubscriptionCollection::class,
                    arguments: ['startIndex' => TypeFactory::getInteger(), 'count' => TypeFactory::getInteger(), 'search' => TypeFactory::getString()],
                ),
                'subscription.create' => new Operation(
                    ...
                    httpCode: 201,
                    return: Message::class,
                    arguments: ['payload' => Model\Consumer\EventSubscriptionCreate::class],
                ),
                'subscription.get' => new Operation(
                    ...
                    httpCode: 200,
                    return: Model\Consumer\EventSubscription::class,
                ),
                'subscription.update' => new Operation(
                    ...
                    httpCode: 200,
                    return: Message::class,
                    arguments: ['payload' => Model\Consumer\EventSubscriptionUpdate::class],
                ),
                ...
                'transaction.getAll' => new Operation(
                    ...
                    httpPath: '/transaction',
                    httpCode: 200,
                    return: Model\Consumer\TransactionCollection::class,
                    arguments: ['startIndex' => TypeFactory::getInteger(), 'count' => TypeFactory::getInteger(), 'search' => TypeFactory::getString()],
                ),
                'transaction.get' => new Operation(
                    ...
                    httpPath: '/transaction/$transaction_id<[0-9]+>',
                    httpCode: 200,
                    return: Model\Consumer\Transaction::class,
                ),
                'account.get' => new Operation(
                    ...
                    httpPath: '/account',
                    httpCode: 200,
                    return: Model\Consumer\UserAccount::class,
                ),
                'account.update' => new Operation(
                    ...
                    httpCode: 200,
                    return: Message::class,
                    arguments: ['payload' => Model\Consumer\UserAccount::class],
                ),
                'account.changePassword' => new Operation(
                ...
                'account.activate' => new Operation(
                    ...
                    httpCode: 200,
                    return: Message::class,
                    arguments: ['payload' => Model\Consumer\UserActivate::class],
                    public: true,
                ),
                ...
                'account.login' => new Operation(
                    ...
                    httpPath: '/login',
                    httpCode: 200,
                    return: Model\Consumer\UserJWT::class,
                    arguments: ['payload' => Model\Consumer\UserLogin::class],
                    public: true,
                ),
                'account.refresh' => new Operation(
                    ...
                    httpCode: 200,
                    return: Model\Consumer\UserJWT::class,
                    arguments: ['payload' => Model\Consumer\UserRefresh::class],
                    public: true,
                ),
                'account.provider' => new Operation(
                    ...
                    httpCode: 200,
                    return: Model\Consumer\UserJWT::class,
                    arguments: ['payload' => Model\Consumer\UserProvider::class],
                    public: true,
                ),
                'account.register' => new Operation(
                    ...
                    httpCode: 200,
                    return: Message::class,
                    arguments: ['payload' => Model\Consumer\UserRegister::class],
                    public: true,
                ),
                'account.requestPasswordReset' => new Operation(
                    ...
                    httpCode: 200,
                    return: Message::class,
                    arguments: ['payload' => Model\Consumer\UserEmail::class],
                    public: true,
                ),
                'account.executePasswordReset' => new Operation(
                    ...
                    httpCode: 200,
                    return: Message::class,
                    arguments: ['payload' => Model\Consumer\UserPasswordReset::class],
                    public: true,
                ),
            ],
            'system' => [
                ...
                'getAllRoutes' => new Operation(
                    ...
                    httpPath: '/route',
                    httpCode: 200,
                    return: Model\System\Route::class,
                    public: true,
                ),
                'getHealth' => new Operation(
                    ...
                    httpPath: '/health',
                    httpCode: 200,
                    return: Model\System\HealthCheck::class,
                    public: true,
                ),
                'getSchema' => new Operation(
                    ...
                    httpCode: 200,
                    return: Model\System\Schema::class,
                    public: true,
                ),
