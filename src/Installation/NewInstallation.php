    ...
    private static function getOperations(): array
    {
        return [
            ...
            'backend' => [
                ...
                'file.getAll' => new Operation(
                    action: Backend\Action\File\GetAll::class,
                    httpMethod: 'GET',
                    httpPath: '/file/:connection_id',
                    httpCode: 200,
                ...
                'file.get' => new Operation(
                    action: Backend\Action\File\Get::class,
                    httpMethod: 'GET',
                ...
                'file.create' => new Operation(
                    action: Backend\Action\File\Create::class,
                    httpMethod: 'POST',
                    httpPath: '/file/:connection_id',
                    httpCode: 201,
                    outgoing: Model\Common\Message::class,
                ...
                'file.update' => new Operation(
                    action: Backend\Action\File\Update::class,
                    httpMethod: 'PUT',
                    httpPath: '/file/:connection_id/:file_id',
                    httpCode: 200,
                    outgoing: Model\Common\Message::class,
