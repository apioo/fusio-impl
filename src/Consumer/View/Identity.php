...
class Identity extends ViewAbstract
{
    ...
    public function getCollection(?int $appId, ?string $appKey, QueryFilter $filter, ContextInterface $context): mixed
    {
        ...
        $condition = $filter->getCondition($this->getTable(Table\App::class), [QueryFilter::COLUMN_SEARCH => Table\Generated\IdentityColumn::NAME]);
