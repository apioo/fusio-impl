 ...
 */
class Version104 implements VersionInterface
{
    ...
    public function getInstallInserts()
    {
        ...
        $data = [
            ...
            'fusio_routes' => [
                ...
                ['status' => 1, 'methods' => 'GET',                 'path' => '/backend/action/list',                         'controller' => Backend\Api\Action\Index::class],
                ['status' => 1, 'methods' => 'GET',                 'path' => '/backend/action/form',                         'controller' => Backend\Api\Action\Form::class],
                ...
                ['status' => 1, 'methods' => 'GET|POST|PUT|DELETE', 'path' => '/backend/app/token',                           'controller' => Backend\Api\App\Token\Collection::class],
                ['status' => 1, 'methods' => 'GET|POST|PUT|DELETE', 'path' => '/backend/app/token/$token_id<[0-9]+>',         'controller' => Backend\Api\App\Token\Entity::class],
                ...
                ['status' => 1, 'methods' => 'GET',                 'path' => '/backend/dashboard',                           'controller' => Backend\Api\Dashboard\Dashboard::class],
