    ...
    public function getInstallInserts()
    {
        ...
        $data = [
            ...
            'fusio_routes' => [
                ...
                ['status' => 1, 'priority' => 0x8000000 | 15,  'methods' => 'ANY', 'path' => '/consumer/app/',                               'controller' => Consumer\Api\App\Collection::class],
                ['status' => 1, 'priority' => 0x8000000 | 14,  'methods' => 'ANY', 'path' => '/consumer/app/$app_id<[0-9]+>',                'controller' => Consumer\Api\App\Entity::class],
                ['status' => 1, 'priority' => 0x8000000 | 13,  'methods' => 'ANY', 'path' => '/consumer/grant',                              'controller' => Consumer\Api\Grant\Collection::class],
                ['status' => 1, 'priority' => 0x8000000 | 12,  'methods' => 'ANY', 'path' => '/consumer/grant/$grant_id<[0-9]+>',            'controller' => Consumer\Api\Grant\Entity::class],
                ['status' => 1, 'priority' => 0x8000000 | 11,  'methods' => 'ANY', 'path' => '/consumer/scope',                              'controller' => Consumer\Api\Scope\Collection::class],
                ['status' => 1, 'priority' => 0x8000000 | 10,  'methods' => 'ANY', 'path' => '/consumer/event',                              'controller' => Consumer\Api\Event\Collection::class],
