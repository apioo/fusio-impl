 ...
 */
class Version310 implements VersionInterface
{
    ...
    public function executeUpgrade(Connection $connection)
    {
        ...
        foreach ($inserts['fusio_routes'] as $row) {
            $route = $connection->fetchAssoc('SELECT id, priority, methods, path FROM fusio_routes WHERE controller = :controller', [
    ...
    public function getInstallInserts()
    {
        ...
        $data = [
            ...
            'fusio_routes' => [
                ['status' => 1, 'priority' => 0x10000000 | 49, 'methods' => 'ANY', 'path' => '/backend/action',                              'controller' => Backend\Api\Action\Collection::class],
                ['status' => 1, 'priority' => 0x10000000 | 48, 'methods' => 'ANY', 'path' => '/backend/action/list',                         'controller' => Backend\Api\Action\Index::class],
                ['status' => 1, 'priority' => 0x10000000 | 47, 'methods' => 'ANY', 'path' => '/backend/action/form',                         'controller' => Backend\Api\Action\Form::class],
                ['status' => 1, 'priority' => 0x10000000 | 46, 'methods' => 'ANY', 'path' => '/backend/action/execute/$action_id<[0-9]+>',   'controller' => Backend\Api\Action\Execute::class],
                ['status' => 1, 'priority' => 0x10000000 | 45, 'methods' => 'ANY', 'path' => '/backend/action/$action_id<[0-9]+>',           'controller' => Backend\Api\Action\Entity::class],
                ['status' => 1, 'priority' => 0x10000000 | 44, 'methods' => 'ANY', 'path' => '/backend/app/token',                           'controller' => Backend\Api\App\Token\Collection::class],
                ['status' => 1, 'priority' => 0x10000000 | 43, 'methods' => 'ANY', 'path' => '/backend/app/token/$token_id<[0-9]+>',         'controller' => Backend\Api\App\Token\Entity::class],
                ['status' => 1, 'priority' => 0x10000000 | 42, 'methods' => 'ANY', 'path' => '/backend/app',                                 'controller' => Backend\Api\App\Collection::class],
                ['status' => 1, 'priority' => 0x10000000 | 41, 'methods' => 'ANY', 'path' => '/backend/app/$app_id<[0-9]+>',                 'controller' => Backend\Api\App\Entity::class],
                ['status' => 1, 'priority' => 0x10000000 | 40, 'methods' => 'ANY', 'path' => '/backend/app/$app_id<[0-9]+>/token/:token_id', 'controller' => Backend\Api\App\Token::class],
                ['status' => 1, 'priority' => 0x10000000 | 39, 'methods' => 'ANY', 'path' => '/backend/audit',                               'controller' => Backend\Api\Audit\Collection::class],
                ['status' => 1, 'priority' => 0x10000000 | 38, 'methods' => 'ANY', 'path' => '/backend/audit/$audit_id<[0-9]+>',             'controller' => Backend\Api\Audit\Entity::class],
                ['status' => 1, 'priority' => 0x10000000 | 37, 'methods' => 'ANY', 'path' => '/backend/config',                              'controller' => Backend\Api\Config\Collection::class],
                ['status' => 1, 'priority' => 0x10000000 | 36, 'methods' => 'ANY', 'path' => '/backend/config/$config_id<[0-9]+>',           'controller' => Backend\Api\Config\Entity::class],
                ['status' => 1, 'priority' => 0x10000000 | 35, 'methods' => 'ANY', 'path' => '/backend/connection',                          'controller' => Backend\Api\Connection\Collection::class],
                ['status' => 1, 'priority' => 0x10000000 | 34, 'methods' => 'ANY', 'path' => '/backend/connection/list',                     'controller' => Backend\Api\Connection\Index::class],
                ['status' => 1, 'priority' => 0x10000000 | 33, 'methods' => 'ANY', 'path' => '/backend/connection/form',                     'controller' => Backend\Api\Connection\Form::class],
                ['status' => 1, 'priority' => 0x10000000 | 32, 'methods' => 'ANY', 'path' => '/backend/connection/$connection_id<[0-9]+>',   'controller' => Backend\Api\Connection\Entity::class],
                ['status' => 1, 'priority' => 0x10000000 | 31, 'methods' => 'ANY', 'path' => '/backend/cronjob',                             'controller' => Backend\Api\Cronjob\Collection::class],
                ['status' => 1, 'priority' => 0x10000000 | 30, 'methods' => 'ANY', 'path' => '/backend/cronjob/$cronjob_id<[0-9]+>',         'controller' => Backend\Api\Cronjob\Entity::class],
                ['status' => 1, 'priority' => 0x10000000 | 29, 'methods' => 'ANY', 'path' => '/backend/event',                               'controller' => Backend\Api\Event\Collection::class],
                ['status' => 1, 'priority' => 0x10000000 | 28, 'methods' => 'ANY', 'path' => '/backend/event/$event_id<[0-9]+>',             'controller' => Backend\Api\Event\Entity::class],
                ['status' => 1, 'priority' => 0x10000000 | 27, 'methods' => 'ANY', 'path' => '/backend/log/error',                           'controller' => Backend\Api\Log\Error\Collection::class],
                ['status' => 1, 'priority' => 0x10000000 | 26, 'methods' => 'ANY', 'path' => '/backend/log/error/$error_id<[0-9]+>',         'controller' => Backend\Api\Log\Error\Entity::class],
                ['status' => 1, 'priority' => 0x10000000 | 25, 'methods' => 'ANY', 'path' => '/backend/log',                                 'controller' => Backend\Api\Log\Collection::class],
                ['status' => 1, 'priority' => 0x10000000 | 24, 'methods' => 'ANY', 'path' => '/backend/log/$log_id<[0-9]+>',                 'controller' => Backend\Api\Log\Entity::class],
                ['status' => 1, 'priority' => 0x10000000 | 23, 'methods' => 'ANY', 'path' => '/backend/rate',                                'controller' => Backend\Api\Rate\Collection::class],
                ['status' => 1, 'priority' => 0x10000000 | 22, 'methods' => 'ANY', 'path' => '/backend/rate/$rate_id<[0-9]+>',               'controller' => Backend\Api\Rate\Entity::class],
                ['status' => 1, 'priority' => 0x10000000 | 21, 'methods' => 'ANY', 'path' => '/backend/routes',                              'controller' => Backend\Api\Routes\Collection::class],
                ...
                ['status' => 1, 'priority' => 0x10000000 | 14, 'methods' => 'ANY', 'path' => '/backend/user',                                'controller' => Backend\Api\User\Collection::class],
                ['status' => 1, 'priority' => 0x10000000 | 13, 'methods' => 'ANY', 'path' => '/backend/user/$user_id<[0-9]+>',               'controller' => Backend\Api\User\Entity::class],
                ['status' => 1, 'priority' => 0x10000000 | 12, 'methods' => 'ANY', 'path' => '/backend/dashboard',                           'controller' => Backend\Api\Dashboard\Dashboard::class],
                ['status' => 1, 'priority' => 0x10000000 | 11, 'methods' => 'ANY', 'path' => '/backend/statistic/incoming_requests',         'controller' => Backend\Api\Statistic\IncomingRequests::class],
                ['status' => 1, 'priority' => 0x10000000 | 10, 'methods' => 'ANY', 'path' => '/backend/statistic/most_used_routes',          'controller' => Backend\Api\Statistic\MostUsedRoutes::class],
                ...
                ['status' => 1, 'priority' => 0x10000000 | 8,  'methods' => 'ANY', 'path' => '/backend/statistic/errors_per_route',          'controller' => Backend\Api\Statistic\ErrorsPerRoute::class],
                ['status' => 1, 'priority' => 0x10000000 | 7,  'methods' => 'ANY', 'path' => '/backend/statistic/issued_tokens',             'controller' => Backend\Api\Statistic\IssuedTokens::class],
                ['status' => 1, 'priority' => 0x10000000 | 6,  'methods' => 'ANY', 'path' => '/backend/statistic/count_requests',            'controller' => Backend\Api\Statistic\CountRequests::class],
                ['status' => 1, 'priority' => 0x10000000 | 5,  'methods' => 'ANY', 'path' => '/backend/statistic/time_average',              'controller' => Backend\Api\Statistic\TimeAverage::class],
                ['status' => 1, 'priority' => 0x10000000 | 4,  'methods' => 'ANY', 'path' => '/backend/statistic/time_per_route',            'controller' => Backend\Api\Statistic\TimePerRoute::class],
                ['status' => 1, 'priority' => 0x10000000 | 3,  'methods' => 'ANY', 'path' => '/backend/account/change_password',             'controller' => Backend\Api\Account\ChangePassword::class],
                ['status' => 1, 'priority' => 0x10000000 | 2,  'methods' => 'ANY', 'path' => '/backend/import/process',                      'controller' => Backend\Api\Import\Process::class],
                ['status' => 1, 'priority' => 0x10000000 | 1,  'methods' => 'ANY', 'path' => '/backend/import/:format',                      'controller' => Backend\Api\Import\Format::class],
                ['status' => 1, 'priority' => 0x10000000 | 0,  'methods' => 'ANY', 'path' => '/backend/token',                               'controller' => Backend\Authorization\Token::class],

                ['status' => 1, 'priority' => 0x8000000 | 15,  'methods' => 'ANY', 'path' => '/consumer/app/developer',                      'controller' => Consumer\Api\App\Developer\Collection::class],
                ['status' => 1, 'priority' => 0x8000000 | 14,  'methods' => 'ANY', 'path' => '/consumer/app/developer/$app_id<[0-9]+>',      'controller' => Consumer\Api\App\Developer\Entity::class],
                ['status' => 1, 'priority' => 0x8000000 | 13,  'methods' => 'ANY', 'path' => '/consumer/app/grant',                          'controller' => Consumer\Api\App\Grant\Collection::class],
                ['status' => 1, 'priority' => 0x8000000 | 12,  'methods' => 'ANY', 'path' => '/consumer/app/grant/$grant_id<[0-9]+>',        'controller' => Consumer\Api\App\Grant\Entity::class],
                ['status' => 1, 'priority' => 0x8000000 | 11,  'methods' => 'ANY', 'path' => '/consumer/app/meta',                           'controller' => Consumer\Api\App\Meta\Entity::class],
                ['status' => 1, 'priority' => 0x8000000 | 10,  'methods' => 'ANY', 'path' => '/consumer/scope',                              'controller' => Consumer\Api\Scope\Collection::class],
                ['status' => 1, 'priority' => 0x8000000 | 9,   'methods' => 'ANY', 'path' => '/consumer/subscription',                       'controller' => Consumer\Api\Subscription\Collection::class],
                ['status' => 1, 'priority' => 0x8000000 | 8,   'methods' => 'ANY', 'path' => '/consumer/subscription/$subscription_id<[0-9]+>', 'controller' => Consumer\Api\Subscription\Entity::class],
                ['status' => 1, 'priority' => 0x8000000 | 7,   'methods' => 'ANY', 'path' => '/consumer/token',                              'controller' => Consumer\Authorization\Token::class],
                ['status' => 1, 'priority' => 0x8000000 | 6,   'methods' => 'ANY', 'path' => '/consumer/authorize',                          'controller' => Consumer\Api\User\Authorize::class],
                ['status' => 1, 'priority' => 0x8000000 | 5,   'methods' => 'ANY', 'path' => '/consumer/login',                              'controller' => Consumer\Api\User\Login::class],
                ['status' => 1, 'priority' => 0x8000000 | 4,   'methods' => 'ANY', 'path' => '/consumer/register',                           'controller' => Consumer\Api\User\Register::class],
                ['status' => 1, 'priority' => 0x8000000 | 3,   'methods' => 'ANY', 'path' => '/consumer/provider/:provider',                 'controller' => Consumer\Api\User\Provider::class],
                ['status' => 1, 'priority' => 0x8000000 | 2,   'methods' => 'ANY', 'path' => '/consumer/activate',                           'controller' => Consumer\Api\User\Activate::class],
                ['status' => 1, 'priority' => 0x8000000 | 1,   'methods' => 'ANY', 'path' => '/consumer/account',                            'controller' => Consumer\Api\User\Account::class],
                ['status' => 1, 'priority' => 0x8000000 | 0,   'methods' => 'ANY', 'path' => '/consumer/account/change_password',            'controller' => Consumer\Api\User\ChangePassword::class],
