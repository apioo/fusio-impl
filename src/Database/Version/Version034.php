 ...
 */
class Version034 implements VersionInterface
{
    ...
    public function getInstallInserts()
    {
        ...
        return [
            ...
            'fusio_routes' => [
                ...
                ['status' => 1, 'methods' => 'GET|POST|PUT|DELETE', 'path' => '/backend/action/execute',                 'controller' => 'Fusio\Impl\Backend\Api\Action\Execute'],
            ...
            'fusio_scope_routes' => [
                ...
                ['scopeId' => 1, 'routeId' => 34, 'allow' => 1, 'methods' => 'GET|POST|PUT|DELETE'],
                ['scopeId' => 1, 'routeId' => 35, 'allow' => 1, 'methods' => 'POST'],
                ['scopeId' => 1, 'routeId' => 36, 'allow' => 1, 'methods' => 'POST'],
                ...
                ['scopeId' => 3, 'routeId' => 52, 'allow' => 1, 'methods' => 'POST'],
                ['scopeId' => 3, 'routeId' => 54, 'allow' => 1, 'methods' => 'GET'],
            ],
            'fusio_user_scope' => [
                ['userId' => 1, 'scopeId' => 1],
                ['userId' => 1, 'scopeId' => 2],
