...
{
    public function __construct(private ConnectionProvider $connectionParser, private FrameworkConfig $frameworkConfig)
    {
    }
    ...
    {
        return [
            'kind' => KindBuilder::build(Model\Backend\ConnectionIndex::class),
