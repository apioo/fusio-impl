...
use Fusio\Model\Backend\GeneratorIndexProviders;
...
{
    public function __construct(private GeneratorProvider $provider)
    {
    }
    ...
    {
        return [
            'kind' => KindBuilder::build(GeneratorIndexProviders::class),
