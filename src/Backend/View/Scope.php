...
class Scope extends ViewAbstract
{
    public function getCollection($startIndex = 0, $search = null)
    {
        ...
        $definition = [
            ...
            'itemsPerPage' => 16,
            'entry' => $this->doCollection([$this->getTable(Table\Scope::class), 'getAll'], [$startIndex, 16, 'id', Sql::SORT_DESC, $condition], [
                'id' => 'id',
                'name' => 'name',
    ...
    public function getEntity($id)
    {
        $definition = $this->doEntity([$this->getTable(Table\Scope::class), 'get'], [$id], [
            ...
            'name' => 'name',
            'description' => 'description',
            'routes' => $this->doCollection([$this->getTable(Table\Scope\Route::class), 'getByScopeId'], [new Reference('id')], [
                'id' => 'id',
                'scopeId' => 'scopeId',
                'routeId' => 'routeId',
                'allow' => 'allow',
