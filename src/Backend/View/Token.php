...
class Token extends ViewAbstract
{
    public function getCollection(TokenQueryFilter $filter, ContextInterface $context)
    {
        ...
        $condition = $filter->getCondition($this->getTable(Table\Token::class), [QueryFilter::COLUMN_SEARCH => Table\Generated\TokenColumn::NAME, DateQueryFilter::COLUMN_DATE => Table\Generated\TokenTable::COLUMN_DATE]);
