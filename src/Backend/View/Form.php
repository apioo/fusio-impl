...
class Form extends ViewAbstract
{
    public function getCollection(QueryFilter $filter, ContextInterface $context): mixed
    {
        ...
        $definition = [
            'kind' => $builder->fieldValue(Service\TypeSystem\KindBuilder::build(Model\Backend\FormCollection::class)),
            ...
            'entry' => $builder->doCollection([$this->getTable(Table\Form::class), 'findAll'], [$condition, $startIndex, $count, $sortBy, $sortOrder], [
                'kind' => $builder->fieldValue(Service\TypeSystem\KindBuilder::build(Model\Backend\Form::class)),
                ...
                'operationId' => Table\Generated\FormTable::COLUMN_OPERATION_ID,
