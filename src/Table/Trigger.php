...
use Fusio\Impl\Table\Generated\TriggerRow;
...
class Trigger extends Generated\TriggerTable
{
    ...
    public function findOneByTenantAndId(?string $tenantId, int $categoryId, int $id): ?TriggerRow
    {
    ...
    public function findOneByTenantAndName(?string $tenantId, ?int $categoryId, string $name): ?TriggerRow
    {
        $condition = Condition::withAnd();
        $condition->equals(self::COLUMN_TENANT_ID, $tenantId);
        if ($categoryId !== null) {
    ...
    /**
     * @return array<TriggerRow>
     */
    public function findByTenantAndEvent(?string $tenantId, string $eventName): array
    {
        $condition = Condition::withAnd();
        $condition->equals(self::COLUMN_TENANT_ID, $tenantId);
        $condition->equals(self::COLUMN_EVENT, $eventName);
