...
class Connection extends Generated\ConnectionTable
{
    ...
    public function findOneByTenantAndId(?string $tenantId, int $id): ?ConnectionRow
    {
    ...
    public function findOneByTenantAndName(?string $tenantId, string $name): ?ConnectionRow
    {
        $condition = Condition::withAnd();
        $condition->equals(self::COLUMN_TENANT_ID, $tenantId);
