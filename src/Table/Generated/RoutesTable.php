...
class RoutesTable extends \PSX\Sql\TableAbstract
{
     ...
     * @throws \PSX\Sql\Exception\QueryException
     */
    public function findOneBy(\PSX\Sql\Condition $condition) : ?\Fusio\Impl\Table\Generated\RoutesRow
    {
     ...
     */
    public function updateById(int $value, \Fusio\Impl\Table\Generated\RoutesRow $record) : int
    {
        $condition = \PSX\Sql\Condition::withAnd();
        $condition->equals('id', $value);
     ...
     * @throws \PSX\Sql\Exception\ManipulationException
     */
    public function updateByCategoryId(int $value, \Fusio\Impl\Table\Generated\RoutesRow $record) : int
    {
        $condition = \PSX\Sql\Condition::withAnd();
        $condition->equals('category_id', $value);
        return $this->doUpdateBy($condition, $record->toRecord());
     ...
     * @throws \PSX\Sql\Exception\ManipulationException
     */
    public function updateByStatus(int $value, \Fusio\Impl\Table\Generated\RoutesRow $record) : int
    {
        $condition = \PSX\Sql\Condition::withAnd();
        $condition->equals('status', $value);
        return $this->doUpdateBy($condition, $record->toRecord());
     ...
     * @throws \PSX\Sql\Exception\ManipulationException
     */
    public function updateByPriority(int $value, \Fusio\Impl\Table\Generated\RoutesRow $record) : int
    {
        $condition = \PSX\Sql\Condition::withAnd();
        $condition->equals('priority', $value);
        return $this->doUpdateBy($condition, $record->toRecord());
     ...
     * @throws \PSX\Sql\Exception\ManipulationException
     */
    public function updateByMethods(string $value, \Fusio\Impl\Table\Generated\RoutesRow $record) : int
    {
        $condition = \PSX\Sql\Condition::withAnd();
        $condition->like('methods', $value);
        return $this->doUpdateBy($condition, $record->toRecord());
     ...
     * @throws \PSX\Sql\Exception\ManipulationException
     */
    public function updateByPath(string $value, \Fusio\Impl\Table\Generated\RoutesRow $record) : int
    {
        $condition = \PSX\Sql\Condition::withAnd();
        $condition->like('path', $value);
        return $this->doUpdateBy($condition, $record->toRecord());
     ...
     * @throws \PSX\Sql\Exception\QueryException
     */
    public function findByController(string $value, ?int $startIndex = null, ?int $count = null, ?string $sortBy = null, ?\PSX\Sql\OrderBy $sortOrder = null) : array
    {
        $condition = \PSX\Sql\Condition::withAnd();
     ...
     * @throws \PSX\Sql\Exception\ManipulationException
     */
    public function updateByController(string $value, \Fusio\Impl\Table\Generated\RoutesRow $record) : int
    {
        $condition = \PSX\Sql\Condition::withAnd();
        $condition->like('controller', $value);
        return $this->doUpdateBy($condition, $record->toRecord());
     ...
     * @throws \PSX\Sql\Exception\ManipulationException
     */
    public function deleteByController(string $value) : int
    {
        $condition = \PSX\Sql\Condition::withAnd();
        $condition->like('controller', $value);
        return $this->doDeleteBy($condition);
     ...
     * @throws \PSX\Sql\Exception\ManipulationException
     */
    public function updateByMetadata(string $value, \Fusio\Impl\Table\Generated\RoutesRow $record) : int
    {
        $condition = \PSX\Sql\Condition::withAnd();
        $condition->like('metadata', $value);
        return $this->doUpdateBy($condition, $record->toRecord());
     ...
     * @throws \PSX\Sql\Exception\ManipulationException
     */
    public function updateBy(\PSX\Sql\Condition $condition, \Fusio\Impl\Table\Generated\RoutesRow $record) : int
    {
        return $this->doUpdateBy($condition, $record->toRecord());
    }
    /**
    ...
    {
        return \Fusio\Impl\Table\Generated\RoutesRow::from($row);
    }
}