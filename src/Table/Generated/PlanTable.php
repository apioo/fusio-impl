...
class PlanTable extends \PSX\Sql\TableAbstract
{
    ...
    public const COLUMN_PERIOD_COUNT = 'period_count';
    ...
    {
        return array(self::COLUMN_ID => 0x3020000a, self::COLUMN_STATUS => 0x20000a, self::COLUMN_NAME => 0xa000ff, self::COLUMN_DESCRIPTION => 0xa000ff, self::COLUMN_PRICE => 0x500000, self::COLUMN_POINTS => 0x20000a, self::COLUMN_PERIOD_TYPE => 0x4020000a, self::COLUMN_PERIOD_COUNT => 0x4020000a, self::COLUMN_EXTERNAL_ID => 0x40a000ff);
    }
    /**
     ...
     * @throws \PSX\Sql\Exception\QueryException
     */
    public function findByPeriodCount(int $value, ?int $startIndex = null, ?int $count = null, ?string $sortBy = null, ?int $sortOrder = null) : array
    {
        $condition = new \PSX\Sql\Condition();
        $condition->equals('period_count', $value);
        return $this->doFindBy($condition, $startIndex, $count, $sortBy, $sortOrder);
    }
    /**
     * @throws \PSX\Sql\Exception\QueryException
     */
    public function findOneByPeriodCount(int $value) : ?\Fusio\Impl\Table\Generated\PlanRow
    {
        $condition = new \PSX\Sql\Condition();
        $condition->equals('period_count', $value);
        return $this->doFindOneBy($condition);
