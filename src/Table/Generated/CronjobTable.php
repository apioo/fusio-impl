...
class CronjobTable extends \PSX\Sql\TableAbstract
{
     ...
     * @throws \PSX\Sql\Exception\QueryException
     */
    public function findByTaxonomyId(int $value, ?int $startIndex = null, ?int $count = null, ?\Fusio\Impl\Table\Generated\CronjobColumn $sortBy = null, ?\PSX\Sql\OrderBy $sortOrder = null): array
    {
        $condition = \PSX\Sql\Condition::withAnd();
     ...
     * @throws \PSX\Sql\Exception\QueryException
     */
    public function findOneByTaxonomyId(int $value): ?\Fusio\Impl\Table\Generated\CronjobRow
    {
        $condition = \PSX\Sql\Condition::withAnd();
        $condition->equals('taxonomy_id', $value);
        return $this->doFindOneBy($condition);
     ...
     * @throws \PSX\Sql\Exception\ManipulationException
     */
    public function updateByTaxonomyId(int $value, \Fusio\Impl\Table\Generated\CronjobRow $record): int
    {
        $condition = \PSX\Sql\Condition::withAnd();
        $condition->equals('taxonomy_id', $value);
        return $this->doUpdateBy($condition, $record->toRecord());
