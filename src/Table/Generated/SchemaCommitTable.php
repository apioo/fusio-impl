...
class SchemaCommitTable extends \PSX\Sql\TableAbstract
{
     ...
     * @throws \PSX\Sql\Exception\QueryException
     */
    public function findBySourceHash(string $value, ?int $startIndex = null, ?int $count = null, ?\Fusio\Impl\Table\Generated\SchemaCommitColumn $sortBy = null, ?\PSX\Sql\OrderBy $sortOrder = null): array
    {
        $condition = \PSX\Sql\Condition::withAnd();
     ...
     * @throws \PSX\Sql\Exception\QueryException
     */
    public function findOneBySourceHash(string $value): ?\Fusio\Impl\Table\Generated\SchemaCommitRow
    {
        $condition = \PSX\Sql\Condition::withAnd();
        $condition->like('source_hash', $value);
        return $this->doFindOneBy($condition);
     ...
     * @throws \PSX\Sql\Exception\ManipulationException
     */
    public function updateBySourceHash(string $value, \Fusio\Impl\Table\Generated\SchemaCommitRow $record): int
    {
        $condition = \PSX\Sql\Condition::withAnd();
        $condition->like('source_hash', $value);
        return $this->doUpdateBy($condition, $record->toRecord());
     ...
     * @throws \PSX\Sql\Exception\ManipulationException
     */
    public function deleteBySourceHash(string $value): int
    {
        $condition = \PSX\Sql\Condition::withAnd();
        $condition->like('source_hash', $value);
        return $this->doDeleteBy($condition);
