...
class AgentTable extends \PSX\Sql\TableAbstract
{
    ...
    public const COLUMN_INTRODUCTION_ACTION = 'introduction_action';
    ...
    {
        return [self::COLUMN_ID => 0x3020000a, self::COLUMN_CATEGORY_ID => 0x20000a, self::COLUMN_CONNECTION_ID => 0x4020000a, self::COLUMN_TENANT_ID => 0x40a00040, self::COLUMN_STATUS => 0x20000a, self::COLUMN_PUBLIC => 0x20000a, self::COLUMN_TYPE => 0x20000a, self::COLUMN_NAME => 0xa000ff, self::COLUMN_DESCRIPTION => 0xa000ff, self::COLUMN_INTRODUCTION => 0xb00000, self::COLUMN_INTRODUCTION_ACTION => 0x40a000ff, self::COLUMN_TEMPERATURE => 0x20000a, self::COLUMN_COSTS => 0x4020000a, self::COLUMN_TOOLS => 0x40b00000, self::COLUMN_OUTGOING => 0x40a000ff, self::COLUMN_METADATA => 0x40b00000, self::COLUMN_INSERT_DATE => 0x800000];
    }
    /**
     ...
     * @throws \PSX\Sql\Exception\QueryException
     */
    public function findByIntroductionAction(string $value, ?int $startIndex = null, ?int $count = null, ?\Fusio\Impl\Table\Generated\AgentColumn $sortBy = null, ?\PSX\Sql\OrderBy $sortOrder = null): array
    {
        $condition = \PSX\Sql\Condition::withAnd();
        $condition->like('introduction_action', $value);
        return $this->doFindBy($condition, $startIndex, $count, $sortBy, $sortOrder);
    }
    /**
     * @throws \PSX\Sql\Exception\QueryException
     */
    public function findOneByIntroductionAction(string $value): ?\Fusio\Impl\Table\Generated\AgentRow
    {
        $condition = \PSX\Sql\Condition::withAnd();
        $condition->like('introduction_action', $value);
        return $this->doFindOneBy($condition);
     ...
     * @throws \PSX\Sql\Exception\ManipulationException
     */
    public function updateByIntroductionAction(string $value, \Fusio\Impl\Table\Generated\AgentRow $record): int
    {
        $condition = \PSX\Sql\Condition::withAnd();
        $condition->like('introduction_action', $value);
        return $this->doUpdateBy($condition, $record->toRecord());
     ...
     * @throws \PSX\Sql\Exception\ManipulationException
     */
    public function deleteByIntroductionAction(string $value): int
    {
        $condition = \PSX\Sql\Condition::withAnd();
        $condition->like('introduction_action', $value);
        return $this->doDeleteBy($condition);
