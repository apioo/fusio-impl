...
class ActionTable extends \PSX\Sql\TableAbstract
{
    ...
    {
        return array(self::COLUMN_ID => 0x3020000a, self::COLUMN_CATEGORY_ID => 0x20000a, self::COLUMN_TENANT_ID => 0x40a00040, self::COLUMN_STATUS => 0x20000a, self::COLUMN_NAME => 0xa000ff, self::COLUMN_CLASS => 0xa000ff, self::COLUMN_ASYNC => 0x400000, self::COLUMN_CONFIG => 0x40b00000, self::COLUMN_METADATA => 0x40b00000, self::COLUMN_DATE => 0x800000);
    }
    /**
     ...
     * @throws \PSX\Sql\Exception\QueryException
     */
    public function findByAsync(bool $value, ?int $startIndex = null, ?int $count = null, ?string $sortBy = null, ?\PSX\Sql\OrderBy $sortOrder = null) : array
    {
        $condition = \PSX\Sql\Condition::withAnd();
