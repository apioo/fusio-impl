...
class EventSubscriptionTable extends \PSX\Sql\TableAbstract
{
     ...
     * @throws \PSX\Sql\Exception\QueryException
     */
    public function findOneBy(\PSX\Sql\Condition $condition) : ?\Fusio\Impl\Table\Generated\EventSubscriptionRow
    {
     ...
     */
    public function updateById(int $value, \Fusio\Impl\Table\Generated\EventSubscriptionRow $record) : int
    {
        $condition = \PSX\Sql\Condition::withAnd();
        $condition->equals('id', $value);
     ...
     * @throws \PSX\Sql\Exception\ManipulationException
     */
    public function updateByEventId(int $value, \Fusio\Impl\Table\Generated\EventSubscriptionRow $record) : int
    {
        $condition = \PSX\Sql\Condition::withAnd();
        $condition->equals('event_id', $value);
        return $this->doUpdateBy($condition, $record->toRecord());
     ...
     * @throws \PSX\Sql\Exception\ManipulationException
     */
    public function updateByUserId(int $value, \Fusio\Impl\Table\Generated\EventSubscriptionRow $record) : int
    {
        $condition = \PSX\Sql\Condition::withAnd();
        $condition->equals('user_id', $value);
        return $this->doUpdateBy($condition, $record->toRecord());
     ...
     * @throws \PSX\Sql\Exception\ManipulationException
     */
    public function updateByStatus(int $value, \Fusio\Impl\Table\Generated\EventSubscriptionRow $record) : int
    {
        $condition = \PSX\Sql\Condition::withAnd();
        $condition->equals('status', $value);
        return $this->doUpdateBy($condition, $record->toRecord());
     ...
     * @throws \PSX\Sql\Exception\ManipulationException
     */
    public function updateByEndpoint(string $value, \Fusio\Impl\Table\Generated\EventSubscriptionRow $record) : int
    {
        $condition = \PSX\Sql\Condition::withAnd();
        $condition->like('endpoint', $value);
        return $this->doUpdateBy($condition, $record->toRecord());
     ...
     * @throws \PSX\Sql\Exception\ManipulationException
     */
    public function updateBy(\PSX\Sql\Condition $condition, \Fusio\Impl\Table\Generated\EventSubscriptionRow $record) : int
    {
        return $this->doUpdateBy($condition, $record->toRecord());
    }
    /**
    ...
    {
        return \Fusio\Impl\Table\Generated\EventSubscriptionRow::from($row);
    }
}