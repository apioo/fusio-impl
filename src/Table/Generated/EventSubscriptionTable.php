...
class EventSubscriptionTable extends \PSX\Sql\TableAbstract
{
    ...
    {
        return array(self::COLUMN_ID => 0x3020000a, self::COLUMN_EVENT_ID => 0x20000a, self::COLUMN_USER_ID => 0x20000a, self::COLUMN_STATUS => 0x20000a, self::COLUMN_ENDPOINT => 0xa000ff);
    }
    /**
     * @return array<\Fusio\Impl\Table\Generated\EventSubscriptionRow>
     ...
     * @throws \PSX\Sql\Exception\QueryException
     */
    public function findOneBy(\PSX\Sql\Condition $condition, ?\PSX\Sql\Fields $fields = null) : ?\Fusio\Impl\Table\Generated\EventSubscriptionRow
    {
     ...
     * @throws \PSX\Sql\Exception\QueryException
     */
    public function find(int $id) : ?\Fusio\Impl\Table\Generated\EventSubscriptionRow
    {
     ...
     * @throws \PSX\Sql\Exception\QueryException
     */
    public function findByEndpoint(string $value, ?int $startIndex = null, ?int $count = null, ?string $sortBy = null, ?int $sortOrder = null) : array
    {
        $condition = new \PSX\Sql\Condition();
     ...
     */
    public function create(\Fusio\Impl\Table\Generated\EventSubscriptionRow $record) : int
    {
     ...
     * @throws \PSX\Sql\Exception\ManipulationException
     */
    public function update(\Fusio\Impl\Table\Generated\EventSubscriptionRow $record) : int
    {
     ...
     * @throws \PSX\Sql\Exception\ManipulationException
     */
    public function delete(\Fusio\Impl\Table\Generated\EventSubscriptionRow $record) : int
    {
     ...
     */
    protected function newRecord(array $row) : \Fusio\Impl\Table\Generated\EventSubscriptionRow
    {
        return new \Fusio\Impl\Table\Generated\EventSubscriptionRow($row);
    }
}