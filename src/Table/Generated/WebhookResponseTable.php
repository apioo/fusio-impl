...
class WebhookResponseTable extends \PSX\Sql\TableAbstract
{
    ...
    {
        return array(self::COLUMN_ID => 0x3020000a, self::COLUMN_WEBHOOK_ID => 0x20000a, self::COLUMN_STATUS => 0x20000a, self::COLUMN_ATTEMPTS => 0x20000a, self::COLUMN_CODE => 0x4020000a, self::COLUMN_BODY => 0x40b00000, self::COLUMN_EXECUTE_DATE => 0x40800000, self::COLUMN_INSERT_DATE => 0x800000);
    }
    /**
     ...
     * @throws \PSX\Sql\Exception\QueryException
     */
    public function findByWebhookId(int $value, ?int $startIndex = null, ?int $count = null, ?string $sortBy = null, ?\PSX\Sql\OrderBy $sortOrder = null) : array
    {
        $condition = \PSX\Sql\Condition::withAnd();
