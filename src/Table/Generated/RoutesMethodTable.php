...
class RoutesMethodTable extends \PSX\Sql\TableAbstract
{
     ...
     * @throws \PSX\Sql\Exception\QueryException
     */
    public function findOneBy(\PSX\Sql\Condition $condition) : ?\Fusio\Impl\Table\Generated\RoutesMethodRow
    {
     ...
     */
    public function updateById(int $value, \Fusio\Impl\Table\Generated\RoutesMethodRow $record) : int
    {
        $condition = \PSX\Sql\Condition::withAnd();
        $condition->equals('id', $value);
     ...
     * @throws \PSX\Sql\Exception\ManipulationException
     */
    public function updateByRouteId(int $value, \Fusio\Impl\Table\Generated\RoutesMethodRow $record) : int
    {
        $condition = \PSX\Sql\Condition::withAnd();
        $condition->equals('route_id', $value);
        return $this->doUpdateBy($condition, $record->toRecord());
     ...
     * @throws \PSX\Sql\Exception\ManipulationException
     */
    public function updateByMethod(string $value, \Fusio\Impl\Table\Generated\RoutesMethodRow $record) : int
    {
        $condition = \PSX\Sql\Condition::withAnd();
        $condition->like('method', $value);
        return $this->doUpdateBy($condition, $record->toRecord());
     ...
     * @throws \PSX\Sql\Exception\QueryException
     */
    public function findByVersion(int $value, ?int $startIndex = null, ?int $count = null, ?string $sortBy = null, ?\PSX\Sql\OrderBy $sortOrder = null) : array
    {
        $condition = \PSX\Sql\Condition::withAnd();
     ...
     * @throws \PSX\Sql\Exception\ManipulationException
     */
    public function updateByVersion(int $value, \Fusio\Impl\Table\Generated\RoutesMethodRow $record) : int
    {
        $condition = \PSX\Sql\Condition::withAnd();
        $condition->equals('version', $value);
        return $this->doUpdateBy($condition, $record->toRecord());
     ...
     * @throws \PSX\Sql\Exception\ManipulationException
     */
    public function deleteByVersion(int $value) : int
    {
        $condition = \PSX\Sql\Condition::withAnd();
        $condition->equals('version', $value);
        return $this->doDeleteBy($condition);
     ...
     * @throws \PSX\Sql\Exception\ManipulationException
     */
    public function updateByStatus(int $value, \Fusio\Impl\Table\Generated\RoutesMethodRow $record) : int
    {
        $condition = \PSX\Sql\Condition::withAnd();
        $condition->equals('status', $value);
        return $this->doUpdateBy($condition, $record->toRecord());
     ...
     * @throws \PSX\Sql\Exception\ManipulationException
     */
    public function updateByActive(int $value, \Fusio\Impl\Table\Generated\RoutesMethodRow $record) : int
    {
        $condition = \PSX\Sql\Condition::withAnd();
        $condition->equals('active', $value);
        return $this->doUpdateBy($condition, $record->toRecord());
     ...
     * @throws \PSX\Sql\Exception\ManipulationException
     */
    public function updateByPublic(int $value, \Fusio\Impl\Table\Generated\RoutesMethodRow $record) : int
    {
        $condition = \PSX\Sql\Condition::withAnd();
        $condition->equals('public', $value);
        return $this->doUpdateBy($condition, $record->toRecord());
     ...
     * @throws \PSX\Sql\Exception\QueryException
     */
    public function findByOperationId(string $value, ?int $startIndex = null, ?int $count = null, ?string $sortBy = null, ?\PSX\Sql\OrderBy $sortOrder = null) : array
    {
        $condition = \PSX\Sql\Condition::withAnd();
     ...
     * @throws \PSX\Sql\Exception\ManipulationException
     */
    public function updateByOperationId(string $value, \Fusio\Impl\Table\Generated\RoutesMethodRow $record) : int
    {
        $condition = \PSX\Sql\Condition::withAnd();
        $condition->like('operation_id', $value);
        return $this->doUpdateBy($condition, $record->toRecord());
     ...
     * @throws \PSX\Sql\Exception\ManipulationException
     */
    public function deleteByOperationId(string $value) : int
    {
        $condition = \PSX\Sql\Condition::withAnd();
        $condition->like('operation_id', $value);
        return $this->doDeleteBy($condition);
     ...
     * @throws \PSX\Sql\Exception\ManipulationException
     */
    public function updateByDescription(string $value, \Fusio\Impl\Table\Generated\RoutesMethodRow $record) : int
    {
        $condition = \PSX\Sql\Condition::withAnd();
        $condition->like('description', $value);
        return $this->doUpdateBy($condition, $record->toRecord());
     ...
     * @throws \PSX\Sql\Exception\ManipulationException
     */
    public function updateByParameters(string $value, \Fusio\Impl\Table\Generated\RoutesMethodRow $record) : int
    {
        $condition = \PSX\Sql\Condition::withAnd();
        $condition->like('parameters', $value);
        return $this->doUpdateBy($condition, $record->toRecord());
     ...
     * @throws \PSX\Sql\Exception\ManipulationException
     */
    public function updateByRequest(string $value, \Fusio\Impl\Table\Generated\RoutesMethodRow $record) : int
    {
        $condition = \PSX\Sql\Condition::withAnd();
        $condition->like('request', $value);
        return $this->doUpdateBy($condition, $record->toRecord());
     ...
     * @throws \PSX\Sql\Exception\ManipulationException
     */
    public function updateByAction(string $value, \Fusio\Impl\Table\Generated\RoutesMethodRow $record) : int
    {
        $condition = \PSX\Sql\Condition::withAnd();
        $condition->like('action', $value);
        return $this->doUpdateBy($condition, $record->toRecord());
     ...
     * @throws \PSX\Sql\Exception\ManipulationException
     */
    public function updateByCosts(int $value, \Fusio\Impl\Table\Generated\RoutesMethodRow $record) : int
    {
        $condition = \PSX\Sql\Condition::withAnd();
        $condition->equals('costs', $value);
        return $this->doUpdateBy($condition, $record->toRecord());
     ...
     * @throws \PSX\Sql\Exception\ManipulationException
     */
    public function updateBy(\PSX\Sql\Condition $condition, \Fusio\Impl\Table\Generated\RoutesMethodRow $record) : int
    {
        return $this->doUpdateBy($condition, $record->toRecord());
    }
    /**
    ...
    {
        return \Fusio\Impl\Table\Generated\RoutesMethodRow::from($row);
    }
}