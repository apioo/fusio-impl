...
class RateTable extends \PSX\Sql\TableAbstract
{
    ...
    {
        return array(self::COLUMN_ID => 0x3020000a, self::COLUMN_TENANT_ID => 0x40a00040, self::COLUMN_STATUS => 0x20000a, self::COLUMN_PRIORITY => 0x20000a, self::COLUMN_NAME => 0xa00040, self::COLUMN_RATE_LIMIT => 0x20000a, self::COLUMN_TIMESPAN => 0xa000ff, self::COLUMN_METADATA => 0x40b00000);
    }
    /**
