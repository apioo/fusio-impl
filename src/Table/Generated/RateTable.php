...
class RateTable extends \PSX\Sql\TableAbstract
{
     ...
     * @throws \PSX\Sql\Exception\QueryException
     */
    public function findByRateLimit(int $value, ?int $startIndex = null, ?int $count = null, ?string $sortBy = null, ?int $sortOrder = null) : array
    {
        $condition = new \PSX\Sql\Condition();
     ...
     * @throws \PSX\Sql\Exception\QueryException
     */
    public function findByTimespan(string $value, ?int $startIndex = null, ?int $count = null, ?string $sortBy = null, ?int $sortOrder = null) : array
    {
        $condition = new \PSX\Sql\Condition();
