...
class ConnectionTable extends \PSX\Sql\TableAbstract
{
    ...
    {
        return array(self::COLUMN_ID => 0x3020000a, self::COLUMN_TENANT_ID => 0x40a00040, self::COLUMN_CATEGORY_ID => 0x20000a, self::COLUMN_STATUS => 0x20000a, self::COLUMN_NAME => 0xa000ff, self::COLUMN_CLASS => 0xa000ff, self::COLUMN_CONFIG => 0x40b00000, self::COLUMN_METADATA => 0x40b00000);
    }
    /**
