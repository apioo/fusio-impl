    ...
    public static function getData()
    {
        ...
        $data = [
            ...
            'fusio_routes' => [
                ...
                ['status' => 1, 'priority' => 0x8000000 | 23, 'methods' => 'ANY', 'path' => '/consumer/app',                                 'controller' => Consumer\Api\App\Collection::class],
                ['status' => 1, 'priority' => 0x8000000 | 22, 'methods' => 'ANY', 'path' => '/consumer/app/$app_id<[0-9]+>',                 'controller' => Consumer\Api\App\Entity::class],
                ['status' => 1, 'priority' => 0x8000000 | 21, 'methods' => 'ANY', 'path' => '/consumer/event',                               'controller' => Consumer\Api\Event\Collection::class],
                ['status' => 1, 'priority' => 0x8000000 | 20, 'methods' => 'ANY', 'path' => '/consumer/grant',                               'controller' => Consumer\Api\Grant\Collection::class],
                ['status' => 1, 'priority' => 0x8000000 | 19, 'methods' => 'ANY', 'path' => '/consumer/grant/$grant_id<[0-9]+>',             'controller' => Consumer\Api\Grant\Entity::class],
                ['status' => 1, 'priority' => 0x8000000 | 18, 'methods' => 'ANY', 'path' => '/consumer/plan/contract',                       'controller' => Consumer\Api\Plan\Contract\Collection::class],
                ['status' => 1, 'priority' => 0x8000000 | 17, 'methods' => 'ANY', 'path' => '/consumer/plan/contract/$contract_id<[0-9]+>',  'controller' => Consumer\Api\Plan\Contract\Entity::class],
