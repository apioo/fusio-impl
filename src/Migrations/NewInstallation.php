...
class NewInstallation
{
    public static function getData()
    {
        ...
        $data = [
            ...
            'fusio_routes' => [
                ['status' => 1, 'priority' => 0x10000000 | 61, 'methods' => 'ANY', 'path' => '/backend/account/change_password',             'controller' => Backend\Api\Account\ChangePassword::class],
                ['status' => 1, 'priority' => 0x10000000 | 60, 'methods' => 'ANY', 'path' => '/backend/action',                              'controller' => Backend\Api\Action\Collection::class],
                ['status' => 1, 'priority' => 0x10000000 | 59, 'methods' => 'ANY', 'path' => '/backend/action/list',                         'controller' => Backend\Api\Action\Index::class],
                ['status' => 1, 'priority' => 0x10000000 | 58, 'methods' => 'ANY', 'path' => '/backend/action/form',                         'controller' => Backend\Api\Action\Form::class],
                ['status' => 1, 'priority' => 0x10000000 | 57, 'methods' => 'ANY', 'path' => '/backend/action/execute/$action_id<[0-9]+>',   'controller' => Backend\Api\Action\Execute::class],
                ['status' => 1, 'priority' => 0x10000000 | 56, 'methods' => 'ANY', 'path' => '/backend/action/$action_id<[0-9]+>',           'controller' => Backend\Api\Action\Entity::class],
                ['status' => 1, 'priority' => 0x10000000 | 55, 'methods' => 'ANY', 'path' => '/backend/app/token',                           'controller' => Backend\Api\App\Token\Collection::class],
                ['status' => 1, 'priority' => 0x10000000 | 54, 'methods' => 'ANY', 'path' => '/backend/app/token/$token_id<[0-9]+>',         'controller' => Backend\Api\App\Token\Entity::class],
                ['status' => 1, 'priority' => 0x10000000 | 53, 'methods' => 'ANY', 'path' => '/backend/app',                                 'controller' => Backend\Api\App\Collection::class],
                ['status' => 1, 'priority' => 0x10000000 | 52, 'methods' => 'ANY', 'path' => '/backend/app/$app_id<[0-9]+>',                 'controller' => Backend\Api\App\Entity::class],
                ['status' => 1, 'priority' => 0x10000000 | 51, 'methods' => 'ANY', 'path' => '/backend/app/$app_id<[0-9]+>/token/:token_id', 'controller' => Backend\Api\App\Token::class],
                ['status' => 1, 'priority' => 0x10000000 | 50, 'methods' => 'ANY', 'path' => '/backend/audit',                               'controller' => Backend\Api\Audit\Collection::class],
                ['status' => 1, 'priority' => 0x10000000 | 49, 'methods' => 'ANY', 'path' => '/backend/audit/$audit_id<[0-9]+>',             'controller' => Backend\Api\Audit\Entity::class],
                ['status' => 1, 'priority' => 0x10000000 | 48, 'methods' => 'ANY', 'path' => '/backend/config',                              'controller' => Backend\Api\Config\Collection::class],
                ['status' => 1, 'priority' => 0x10000000 | 47, 'methods' => 'ANY', 'path' => '/backend/config/$config_id<[0-9]+>',           'controller' => Backend\Api\Config\Entity::class],
                ['status' => 1, 'priority' => 0x10000000 | 46, 'methods' => 'ANY', 'path' => '/backend/connection',                          'controller' => Backend\Api\Connection\Collection::class],
                ['status' => 1, 'priority' => 0x10000000 | 45, 'methods' => 'ANY', 'path' => '/backend/connection/list',                     'controller' => Backend\Api\Connection\Index::class],
                ['status' => 1, 'priority' => 0x10000000 | 44, 'methods' => 'ANY', 'path' => '/backend/connection/form',                     'controller' => Backend\Api\Connection\Form::class],
                ['status' => 1, 'priority' => 0x10000000 | 43, 'methods' => 'ANY', 'path' => '/backend/connection/$connection_id<[0-9]+>',   'controller' => Backend\Api\Connection\Entity::class],
                ['status' => 1, 'priority' => 0x10000000 | 42, 'methods' => 'ANY', 'path' => '/backend/cronjob',                             'controller' => Backend\Api\Cronjob\Collection::class],
                ['status' => 1, 'priority' => 0x10000000 | 41, 'methods' => 'ANY', 'path' => '/backend/cronjob/$cronjob_id<[0-9]+>',         'controller' => Backend\Api\Cronjob\Entity::class],
                ['status' => 1, 'priority' => 0x10000000 | 40, 'methods' => 'ANY', 'path' => '/backend/dashboard',                           'controller' => Backend\Api\Dashboard\Dashboard::class],
                ['status' => 1, 'priority' => 0x10000000 | 39, 'methods' => 'ANY', 'path' => '/backend/event',                               'controller' => Backend\Api\Event\Collection::class],
                ['status' => 1, 'priority' => 0x10000000 | 38, 'methods' => 'ANY', 'path' => '/backend/event/$event_id<[0-9]+>',             'controller' => Backend\Api\Event\Entity::class],
                ['status' => 1, 'priority' => 0x10000000 | 37, 'methods' => 'ANY', 'path' => '/backend/import/process',                      'controller' => Backend\Api\Import\Process::class],
                ['status' => 1, 'priority' => 0x10000000 | 36, 'methods' => 'ANY', 'path' => '/backend/import/:format',                      'controller' => Backend\Api\Import\Format::class],
                ['status' => 1, 'priority' => 0x10000000 | 35, 'methods' => 'ANY', 'path' => '/backend/log/error',                           'controller' => Backend\Api\Log\Error\Collection::class],
                ['status' => 1, 'priority' => 0x10000000 | 34, 'methods' => 'ANY', 'path' => '/backend/log/error/$error_id<[0-9]+>',         'controller' => Backend\Api\Log\Error\Entity::class],
                ['status' => 1, 'priority' => 0x10000000 | 33, 'methods' => 'ANY', 'path' => '/backend/log',                                 'controller' => Backend\Api\Log\Collection::class],
                ['status' => 1, 'priority' => 0x10000000 | 32, 'methods' => 'ANY', 'path' => '/backend/log/$log_id<[0-9]+>',                 'controller' => Backend\Api\Log\Entity::class],
                ['status' => 1, 'priority' => 0x10000000 | 31, 'methods' => 'ANY', 'path' => '/backend/plan/contract',                       'controller' => Backend\Api\Plan\Contract\Collection::class],
                ['status' => 1, 'priority' => 0x10000000 | 30, 'methods' => 'ANY', 'path' => '/backend/plan/contract/$contract_id<[0-9]+>',  'controller' => Backend\Api\Plan\Contract\Entity::class],
                ['status' => 1, 'priority' => 0x10000000 | 29, 'methods' => 'ANY', 'path' => '/backend/plan/invoice',                        'controller' => Backend\Api\Plan\Invoice\Collection::class],
                ['status' => 1, 'priority' => 0x10000000 | 28, 'methods' => 'ANY', 'path' => '/backend/plan/invoice/$invoice_id<[0-9]+>',    'controller' => Backend\Api\Plan\Invoice\Entity::class],
                ['status' => 1, 'priority' => 0x10000000 | 27, 'methods' => 'ANY', 'path' => '/backend/plan',                                'controller' => Backend\Api\Plan\Collection::class],
                ['status' => 1, 'priority' => 0x10000000 | 26, 'methods' => 'ANY', 'path' => '/backend/plan/$plan_id<[0-9]+>',               'controller' => Backend\Api\Plan\Entity::class],
                ['status' => 1, 'priority' => 0x10000000 | 25, 'methods' => 'ANY', 'path' => '/backend/rate',                                'controller' => Backend\Api\Rate\Collection::class],
                ['status' => 1, 'priority' => 0x10000000 | 24, 'methods' => 'ANY', 'path' => '/backend/rate/$rate_id<[0-9]+>',               'controller' => Backend\Api\Rate\Entity::class],
                ['status' => 1, 'priority' => 0x10000000 | 23, 'methods' => 'ANY', 'path' => '/backend/routes',                              'controller' => Backend\Api\Routes\Collection::class],
                ['status' => 1, 'priority' => 0x10000000 | 22, 'methods' => 'ANY', 'path' => '/backend/routes/provider/:provider',           'controller' => Backend\Api\Routes\Provider::class],
                ...
                ['status' => 1, 'priority' => 0x8000000 | 25, 'methods' => 'ANY', 'path' => '/consumer/app',                                 'controller' => Consumer\Api\App\Collection::class],
                ['status' => 1, 'priority' => 0x8000000 | 24, 'methods' => 'ANY', 'path' => '/consumer/app/$app_id<[0-9]+>',                 'controller' => Consumer\Api\App\Entity::class],
                ['status' => 1, 'priority' => 0x8000000 | 23, 'methods' => 'ANY', 'path' => '/consumer/event',                               'controller' => Consumer\Api\Event\Collection::class],
                ['status' => 1, 'priority' => 0x8000000 | 22, 'methods' => 'ANY', 'path' => '/consumer/grant',                               'controller' => Consumer\Api\Grant\Collection::class],
                ['status' => 1, 'priority' => 0x8000000 | 21, 'methods' => 'ANY', 'path' => '/consumer/grant/$grant_id<[0-9]+>',             'controller' => Consumer\Api\Grant\Entity::class],
                ['status' => 1, 'priority' => 0x8000000 | 20, 'methods' => 'ANY', 'path' => '/consumer/plan/contract',                       'controller' => Consumer\Api\Plan\Contract\Collection::class],
                ['status' => 1, 'priority' => 0x8000000 | 19, 'methods' => 'ANY', 'path' => '/consumer/plan/contract/$contract_id<[0-9]+>',  'controller' => Consumer\Api\Plan\Contract\Entity::class],
                ['status' => 1, 'priority' => 0x8000000 | 18, 'methods' => 'ANY', 'path' => '/consumer/plan/invoice',                        'controller' => Consumer\Api\Plan\Invoice\Collection::class],
                ['status' => 1, 'priority' => 0x8000000 | 17, 'methods' => 'ANY', 'path' => '/consumer/plan/invoice/$invoice_id<[0-9]+>',    'controller' => Consumer\Api\Plan\Invoice\Entity::class],
                ...
                ['status' => 1, 'priority' => 0x1000000 | 7,   'methods' => 'ANY', 'path' => '/export/jsonrpc',                              'controller' => Export\Api\JsonRpc::class],
                ['status' => 1, 'priority' => 0x1000000 | 6,   'methods' => 'ANY', 'path' => '/export/health',                               'controller' => Export\Api\Health::class],
                ['status' => 1, 'priority' => 0x1000000 | 5,   'methods' => 'ANY', 'path' => '/export/debug',                                'controller' => Export\Api\Debug::class],
