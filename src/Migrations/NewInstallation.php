    ...
    public static function getData()
    {
        ...
        $data = [
            ...
            'fusio_routes' => [
                ...
                ['status' => 1, 'priority' => 0x8000000 | 14, 'methods' => 'ANY', 'path' => '/consumer/subscription',                        'controller' => Consumer\Api\Subscription\Collection::class],
                ['status' => 1, 'priority' => 0x8000000 | 13, 'methods' => 'ANY', 'path' => '/consumer/subscription/$subscription_id<[0-9]+>', 'controller' => Consumer\Api\Subscription\Entity::class],
