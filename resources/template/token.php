...
<div class="container bg-light mb-xl-5 mt-xl-5 shadow-lg" style="max-width:640px;z-index:1024">
  ...
  <div class="mt-5 pb-5 mb-3 border-bottom">
    <p class="lead">You have successfully requested an Access-Token, please provide the Access-Token to your app, then you can close this window</p>
    <dl>
      <dt>Access-Token</dt>
