...
class LoginTest extends ControllerDbTestCase
{
    ...
    public function testPost()
    {
        ...
        $this->assertEquals('consumer,consumer.app,consumer.event,consumer.log,consumer.grant,consumer.page,consumer.plan,consumer.scope,consumer.subscription,consumer.transaction,consumer.user,authorization,foo,bar', $row['scope']);
