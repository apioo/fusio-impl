...
class LoginTest extends ControllerDbTestCase
{
    ...
    public function testPost()
    {
        ...
        $this->assertEquals('consumer,consumer.account,consumer.app,consumer.event,consumer.grant,consumer.identity,consumer.log,consumer.page,consumer.payment,consumer.plan,consumer.scope,consumer.transaction,consumer.webhook,authorization,foo,bar', $row['scope']);
