...
class ExchangeTest extends DbTestCase
{
    ...
    protected function assertToken(string $jwt, int $identityId): void
    {
        ...
        $this->assertEquals('consumer,consumer.account,consumer.agent,consumer.app,consumer.event,consumer.form,consumer.grant,consumer.identity,consumer.log,consumer.page,consumer.payment,consumer.plan,consumer.scope,consumer.token,consumer.transaction,consumer.webhook,authorization,default', $row['scope']);
