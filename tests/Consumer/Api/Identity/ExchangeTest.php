...
class ExchangeTest extends ControllerDbTestCase
{
    ...
    {
        $response = $this->sendRequest('/consumer/identity/1/exchange?code=foobar&client_id=foo&state=foobar&redirect_uri=' . urlencode('http://127.0.0.1/consumer/identity/1/exchange'), 'GET', array(
