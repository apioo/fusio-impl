 ...
 */
class PortalTest extends ControllerDbTestCase
{
    ...
    {
        $response = $this->sendRequest('/system/doc/*/consumer/payment/paypal/portal', 'GET', array(
            'User-Agent'    => 'Fusio TestCase',
            'Authorization' => 'Bearer da250526d583edabca8ac2f99e37ee39aa02a3c076c0edc6929095e20ca18dcf'
        ));

        $actual = Documentation::getResource($response);
        $expect = file_get_contents(__DIR__ . '/resource/portal.json');
