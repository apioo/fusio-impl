    ...
    protected static function getTestInserts()
    {
        ...
        return [
            ...
            'fusio_app_token' => [
                ...
                ['app_id' => 3, 'user_id' => 4, 'status' => 1, 'token' => 'e4a4d21e8ca88b215572b4d8635c492d8877fd8d3de6b98ba7c08d282adfb94f', 'refresh' => 'da250526d583edabca8ac2f99e37ee39aa02a3c076c0edc6929095e20ca18dcf', 'scope' => 'bar', 'ip' => '127.0.0.1', 'expire' => $expire->format('Y-m-d H:i:s'), 'date' => '2015-06-25 22:49:09'],
                ...
                ['app_id' => 1, 'user_id' => 4, 'status' => 1, 'token' => 'bae8116c20aaa2a13774345f4a5d98bacbb2062ae79122c9c4f5ea6b767c1b9a', 'refresh' => 'da250526d583edabca8ac2f99e37ee39aa02a3c076c0edc6929095e20ca18dcf', 'scope' => 'backend', 'ip' => '127.0.0.1', 'expire' => $expire->format('Y-m-d H:i:s'), 'date' => '2015-06-25 22:49:09'],
            ],
            'fusio_scope_routes' => [
                ['scope_id' => 5, 'route_id' => self::getLastRouteId(), 'allow' => 1, 'methods' => 'GET|POST|PUT|PATCH|DELETE'],
                ['scope_id' => 5, 'route_id' => self::getLastRouteId() + 1, 'allow' => 1, 'methods' => 'GET|POST|PUT|PATCH|DELETE'],
                ['scope_id' => 5, 'route_id' => self::getLastRouteId() + 2, 'allow' => 1, 'methods' => 'GET|POST|PUT|PATCH|DELETE'],
            ],
            'fusio_user_scope' => [
                ['user_id' => 1, 'scope_id' => 4],
                ['user_id' => 1, 'scope_id' => 5],
                ['user_id' => 2, 'scope_id' => 2],
                ['user_id' => 2, 'scope_id' => 3],
                ['user_id' => 2, 'scope_id' => 4],
                ['user_id' => 2, 'scope_id' => 5],
