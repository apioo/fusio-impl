    ...
    private static function appendTestInserts(DataBag $data): void
    {
        ...
        $data->addOperations(null, 'default', [
            ...
            'test.createBar' => new Operation(
                ...
                httpPath: '/bar',
                httpCode: 201,
                outgoing: 'Entry-Schema@7d28d0f99f1d839a054cf080b37556d77166d788',
                incoming: 'Entry-Schema@7d28d0f99f1d839a054cf080b37556d77166d788',
                costs: 1,
            ),
        ...
        $data->addScopeOperation('bar', 'test.createBar');
