    ...
    protected static function getTestInserts()
    {
        ...
        return [
            ...
            'fusio_app_token' => [
                ...
                ['app_id' => 3, 'user_id' => 2, 'status' => 1, 'token' => 'b41344388feed85bc362e518387fdc8c81b896bfe5e794131e1469770571d873', 'refresh' => 'b8f6f61bd22b440a3e4be2b7491066682bfcde611dbefa1b15d2e7f6522d77e2', 'scope' => 'bar', 'ip' => '127.0.0.1', 'expire' => $expire->format('Y-m-d H:i:s'), 'date' => $now->format('Y-m-d H:i:s')],
