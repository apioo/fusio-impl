    ...
    protected static function getTestInserts()
    {
        ...
        return [
            ...
            'fusio_routes_response' => [
                ['method_id' => 2, 'code' => 200, 'response' => 'Collection-Schema'],
                ['method_id' => 3, 'code' => 201, 'response' => 'Passthru'],

                ['method_id' => 7, 'code' => 200, 'response' => 'Passthru'],
                ['method_id' => 8, 'code' => 200, 'response' => 'Passthru'],
                ['method_id' => 9, 'code' => 200, 'response' => 'Passthru'],
                ['method_id' => 10, 'code' => 200, 'response' => 'Passthru'],
            ...
            'fusio_routes_method' => [
                ...
                ['route_id' => self::getLastRouteId() + 2, 'method' => 'GET', 'version' => 1, 'status' => Resource::STATUS_DEVELOPMENT, 'active' => 1, 'public' => 1, 'operation_id' => null, 'parameters' => null, 'request' => 'Passthru', 'action' => 'Inspect-Action', 'costs' => null],
                ['route_id' => self::getLastRouteId() + 2, 'method' => 'POST', 'version' => 1, 'status' => Resource::STATUS_DEVELOPMENT, 'active' => 1, 'public' => 1, 'operation_id' => null, 'parameters' => null, 'request' => 'Passthru', 'action' => 'Inspect-Action', 'costs' => null],
                ['route_id' => self::getLastRouteId() + 2, 'method' => 'PUT', 'version' => 1, 'status' => Resource::STATUS_DEVELOPMENT, 'active' => 1, 'public' => 1, 'operation_id' => null, 'parameters' => null, 'request' => 'Passthru', 'action' => 'Inspect-Action', 'costs' => null],
                ['route_id' => self::getLastRouteId() + 2, 'method' => 'PATCH', 'version' => 1, 'status' => Resource::STATUS_DEVELOPMENT, 'active' => 1, 'public' => 1, 'operation_id' => null, 'parameters' => null, 'request' => 'Passthru', 'action' => 'Inspect-Action', 'costs' => null],
                ['route_id' => self::getLastRouteId() + 2, 'method' => 'DELETE','version' => 1, 'status' => Resource::STATUS_DEVELOPMENT, 'active' => 1, 'public' => 1, 'operation_id' => null, 'parameters' => null, 'request' => 'Passthru', 'action' => 'Inspect-Action', 'costs' => null],
            ],
            'fusio_log' => [
