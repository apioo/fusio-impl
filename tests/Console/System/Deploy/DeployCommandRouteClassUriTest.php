...
/**
 * DeployCommandRouteClassUriTest
 *
 * @author  Christoph Kappestein <christoph.kappestein@gmail.com>
 * @license http://www.gnu.org/licenses/agpl-3.0
 * @link    http://fusio-project.org
 */
class DeployCommandRouteClassUriTest extends ControllerDbTestCase
{
    ...
    public function testCommandRoutesActionClass()
    {
        ...
        $commandTester->execute([
            ...
            'file'    => __DIR__ . '/../resource/deploy_routes_action_class_uri.yaml',
        ]);

        $display = $commandTester->getDisplay();

        $this->assertRegExp('/- \[CREATED\] action Fusio_Impl_Tests_Console_System_Action_TestAction/', $display, $display);
