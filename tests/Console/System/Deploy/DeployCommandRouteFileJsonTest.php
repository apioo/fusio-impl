...
use Fusio\Impl\Factory\Resolver\StaticFile;
...
/**
 * DeployCommandRouteFileJsonTest
 *
 * @author  Christoph Kappestein <christoph.kappestein@gmail.com>
 * @license http://www.gnu.org/licenses/agpl-3.0
 * @link    http://fusio-project.org
 */
class DeployCommandRouteFileJsonTest extends ControllerDbTestCase
{
    ...
    public function testCommandRoutesActionClass()
    {
        ...
        $commandTester->execute([
            ...
            'file'    => __DIR__ . '/../resource/deploy_routes_action_file_json.yaml',
        ]);

        $display = $commandTester->getDisplay();

        $this->assertRegExp('/- \[CREATED\] action s_Console_System_resource_static_json/', $display, $display);
        ...
        $this->assertEquals('s_Console_System_resource_static_json', $methods[0]['action']);
