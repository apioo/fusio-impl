...
class ClientCredentialsTest extends ControllerDbTestCase
{
    ...
    public function testPostConsumer()
    {
        ...
        $this->assertAccessToken($response, 'consumer,consumer.app,consumer.event,consumer.grant,consumer.plan,consumer.scope,consumer.subscription,consumer.transaction,consumer.user,authorization,foo,bar', 2);
    }
