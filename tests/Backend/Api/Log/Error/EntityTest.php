...
class EntityTest extends ControllerDbTestCase
{
    ...
    {
        $response = $this->sendRequest('http://127.0.0.1/doc/*/backend/log/error/1', 'GET', array(
        ...
        $expect = <<<'JSON'
{
    ...
    "links": [
        {
            "rel": "swagger",
            "href": "\/export\/swagger\/*\/backend\/log\/error\/:error_id"
        },
        {
            "rel": "raml",
            "href": "\/export\/raml\/*\/backend\/log\/error\/:error_id"
        }
    ]
}
JSON;
