...
class CollectionTest extends DbTestCase
{
    ...
    {
        $response = $this->sendRequest('/backend/plan', 'GET', [
        ...
        $expect = <<<'JSON'
{
    "@type": "https://typehub.cloud/s/fusio/sdk/7.0.7/Backend_PlanCollection",
    "totalResults": 2,
    "startIndex": 0,
    "itemsPerPage": 16,
    "entry": [
        {
            "@type": "https://typehub.cloud/s/fusio/sdk/7.0.7/Backend_Plan",
            "id": 1,
            "status": 1,
            "name": "Plan A",
            "description": "",
...
JSON;
    ...
    public function testPost(): void
    {
        ...
        $response = $this->sendRequest('/backend/plan', 'POST', [
            'User-Agent'    => 'Fusio TestCase',
            'Authorization' => 'Bearer da250526d583edabca8ac2f99e37ee39aa02a3c076c0edc6929095e20ca18dcf'
        ], json_encode([
            'name'        => 'Plan D',
...
JSON;
    ...
    {
        $response = $this->sendRequest('/backend/plan', 'PUT', [
            'User-Agent'    => 'Fusio TestCase',
            'Authorization' => 'Bearer da250526d583edabca8ac2f99e37ee39aa02a3c076c0edc6929095e20ca18dcf'
        ], json_encode([
            'foo' => 'bar',
    ...
    {
        $response = $this->sendRequest('/backend/plan', 'DELETE', [
            'User-Agent'    => 'Fusio TestCase',
            'Authorization' => 'Bearer da250526d583edabca8ac2f99e37ee39aa02a3c076c0edc6929095e20ca18dcf'
        ], json_encode([
            'foo' => 'bar',
