...
class MostUsedAppsTest extends ControllerDbTestCase
{
    ...
    {
        $response = $this->sendRequest('http://127.0.0.1/doc/*/backend/statistic/most_used_apps', 'GET', array(
        ...
        $expect = <<<'JSON'
{
    ...
    "links": [
        {
            "rel": "openapi",
            "href": "\/export\/openapi\/*\/backend\/statistic\/most_used_apps"
        },
        {
            "rel": "swagger",
            "href": "\/export\/swagger\/*\/backend\/statistic\/most_used_apps"
        },
        {
            "rel": "raml",
            "href": "\/export\/raml\/*\/backend\/statistic\/most_used_apps"
        }
    ]
}
JSON;
