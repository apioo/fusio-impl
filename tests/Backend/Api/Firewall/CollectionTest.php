...
class CollectionTest extends DbTestCase
{
    ...
    {
        $response = $this->sendRequest('/backend/firewall', 'GET', [
...
JSON;
    ...
    public function testPost(): void
    {
        ...
        $response = $this->sendRequest('/backend/firewall', 'POST', [
            'User-Agent'    => 'Fusio TestCase',
            'Authorization' => 'Bearer da250526d583edabca8ac2f99e37ee39aa02a3c076c0edc6929095e20ca18dcf'
        ], json_encode([
            'name'     => 'another-rule',
...
JSON;
    ...
    {
        $response = $this->sendRequest('/backend/firewall', 'PUT', [
            'User-Agent'    => 'Fusio TestCase',
            'Authorization' => 'Bearer da250526d583edabca8ac2f99e37ee39aa02a3c076c0edc6929095e20ca18dcf'
        ], json_encode([
            'foo' => 'bar',
    ...
    {
        $response = $this->sendRequest('/backend/firewall', 'DELETE', [
            'User-Agent'    => 'Fusio TestCase',
            'Authorization' => 'Bearer da250526d583edabca8ac2f99e37ee39aa02a3c076c0edc6929095e20ca18dcf'
        ], json_encode([
            'foo' => 'bar',
