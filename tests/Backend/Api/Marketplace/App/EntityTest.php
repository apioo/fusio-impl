...
class EntityTest extends DbTestCase
{
    ...
    {
        $response = $this->sendRequest('/backend/marketplace/app/fusio/fusio', 'GET', [
    ...
    {
        $response = $this->sendRequest('/backend/marketplace/app/fusio/foobar', 'GET', [
            'User-Agent'    => 'Fusio TestCase',
            'Authorization' => 'Bearer da250526d583edabca8ac2f99e37ee39aa02a3c076c0edc6929095e20ca18dcf'
        ]);
    ...
    public function testPost(): void
    {
        ...
        $response = $this->sendRequest('/backend/marketplace/app/fusio/fusio', 'POST', [
            'User-Agent'    => 'Fusio TestCase',
            'Authorization' => 'Bearer da250526d583edabca8ac2f99e37ee39aa02a3c076c0edc6929095e20ca18dcf'
        ], json_encode([
            'foo' => 'bar',
    ...
    public function testPut(): void
    {
        ...
        $response = $this->sendRequest('/backend/marketplace/app/fusio/fusio', 'PUT', [
            'User-Agent'    => 'Fusio TestCase',
            'Authorization' => 'Bearer da250526d583edabca8ac2f99e37ee39aa02a3c076c0edc6929095e20ca18dcf'
        ]);
...
JSON;
    ...
    public function testDelete(): void
    {
        ...
        $response = $this->sendRequest('/backend/marketplace/app/fusio/fusio', 'DELETE', [
            'User-Agent'    => 'Fusio TestCase',
            'Authorization' => 'Bearer da250526d583edabca8ac2f99e37ee39aa02a3c076c0edc6929095e20ca18dcf'
        ]);
