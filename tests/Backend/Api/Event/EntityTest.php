...
class EntityTest extends DbTestCase
{
    ...
    {
        $response = $this->sendRequest('/backend/event/' . $this->id, 'GET', [
        ...
        $expect = <<<JSON
{
    "@type": "https://typehub.cloud/s/fusio/sdk/7.0.7/Backend_Event",
    "id": {$this->id},
    "status": 1,
    "name": "foo-event",
...
JSON;
    ...
    {
        $response = $this->sendRequest('/backend/event/~foo-event', 'GET', [
            'User-Agent'    => 'Fusio TestCase',
            'Authorization' => 'Bearer da250526d583edabca8ac2f99e37ee39aa02a3c076c0edc6929095e20ca18dcf'
        ]);
...
JSON;
    ...
    {
        $response = $this->sendRequest('/backend/event/370', 'GET', [
            'User-Agent'    => 'Fusio TestCase',
            'Authorization' => 'Bearer da250526d583edabca8ac2f99e37ee39aa02a3c076c0edc6929095e20ca18dcf'
        ]);
    ...
    {
        $response = $this->sendRequest('/backend/event/' . $this->id, 'POST', [
            'User-Agent'    => 'Fusio TestCase',
            'Authorization' => 'Bearer da250526d583edabca8ac2f99e37ee39aa02a3c076c0edc6929095e20ca18dcf'
        ], json_encode([
            'foo' => 'bar',
    ...
    public function testPut(): void
    {
        ...
        $response = $this->sendRequest('/backend/event/' . $this->id, 'PUT', [
            'User-Agent'    => 'Fusio TestCase',
            'Authorization' => 'Bearer da250526d583edabca8ac2f99e37ee39aa02a3c076c0edc6929095e20ca18dcf'
        ], json_encode([
            'name'        => 'New-Test',
...
JSON;
    ...
    {
        $response = $this->sendRequest('/backend/event/' . $this->id, 'DELETE', [
            'User-Agent'    => 'Fusio TestCase',
            'Authorization' => 'Bearer da250526d583edabca8ac2f99e37ee39aa02a3c076c0edc6929095e20ca18dcf'
        ]);
