...
class EntityTest extends ControllerDbTestCase
{
    ...
    {
        $response = $this->sendRequest('http://127.0.0.1/backend/routes/60', 'GET', array(
...
JSON;
    ...
    {
        $response = $this->sendRequest('http://127.0.0.1/backend/routes/60', 'POST', array(
            'User-Agent'    => 'Fusio TestCase',
            'Authorization' => 'Bearer da250526d583edabca8ac2f99e37ee39aa02a3c076c0edc6929095e20ca18dcf'
        ), json_encode([
            'foo' => 'bar',
    ...
    {
        $response = $this->sendRequest('http://127.0.0.1/backend/routes/60', 'PUT', array(
            'User-Agent'    => 'Fusio TestCase',
            'Authorization' => 'Bearer da250526d583edabca8ac2f99e37ee39aa02a3c076c0edc6929095e20ca18dcf'
        ), json_encode([
            'path'   => '/foo',
...
JSON;
    ...
    {
        $response = $this->sendRequest('http://127.0.0.1/backend/routes/60', 'DELETE', array(
            'User-Agent'    => 'Fusio TestCase',
            'Authorization' => 'Bearer da250526d583edabca8ac2f99e37ee39aa02a3c076c0edc6929095e20ca18dcf'
        ));
