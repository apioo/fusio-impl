...
class EntityTest extends ControllerDbTestCase
{
    ...
    {
        $response = $this->sendRequest('http://127.0.0.1/doc/*/backend/scope/5', 'GET', array(
        ...
        $expect = <<<'JSON'
{
    ...
    "links": [
        {
            "rel": "swagger",
            "href": "\/export\/swagger\/*\/backend\/scope\/:scope_id"
        },
        {
            "rel": "raml",
            "href": "\/export\/raml\/*\/backend\/scope\/:scope_id"
        }
    ]
}
JSON;
