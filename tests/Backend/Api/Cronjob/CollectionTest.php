...
JSON;
    ...
    {
        $response = $this->sendRequest('/backend/cronjob?search=Test', 'GET', array(
            'User-Agent'    => 'Fusio TestCase',
            'Authorization' => 'Bearer da250526d583edabca8ac2f99e37ee39aa02a3c076c0edc6929095e20ca18dcf'
        ));
...
5 * * * * {$cronUser} {$cronExec} cronjob 6
*/30 * * * * {$cronUser} {$cronExec} cronjob 5
0 * * * * {$cronUser} {$cronExec} cronjob 4
0 0 * * * {$cronUser} {$cronExec} cronjob 3
* * * * * {$cronUser} {$cronExec} cronjob 2
* * * * * {$cronUser} {$cronExec} cronjob 1
