...
class CollectionTest extends DbTestCase
{
    ...
    {
        $response = $this->sendRequest('/backend/webhook', 'GET', [
...
JSON;
    ...
    {
        $response = $this->sendRequest('/backend/webhook', 'POST', [
            'User-Agent'    => 'Fusio TestCase',
            'Authorization' => 'Bearer da250526d583edabca8ac2f99e37ee39aa02a3c076c0edc6929095e20ca18dcf'
        ], json_encode([
            'eventId'  => $this->eventId,
...
JSON;
    ...
    {
        $response = $this->sendRequest('/backend/webhook', 'PUT', [
            'User-Agent'    => 'Fusio TestCase',
            'Authorization' => 'Bearer da250526d583edabca8ac2f99e37ee39aa02a3c076c0edc6929095e20ca18dcf'
        ], json_encode([
            'foo' => 'bar',
    ...
    {
        $response = $this->sendRequest('/backend/webhook', 'DELETE', [
            'User-Agent'    => 'Fusio TestCase',
            'Authorization' => 'Bearer da250526d583edabca8ac2f99e37ee39aa02a3c076c0edc6929095e20ca18dcf'
        ], json_encode([
            'foo' => 'bar',
